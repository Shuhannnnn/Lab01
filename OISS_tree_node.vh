//////// DEPTH 3 //////// 
// depth-2 branches
wire [8:0] n_AA_ready = n_AA_sl + 9'd1;
wire [8:0] n_AB_ready = n_AB_sl + 9'd1;
wire [8:0] n_BA_ready = n_BA_sl + 9'd1;
wire [8:0] n_BB_ready = n_BB_sl + 9'd1;

// n_AAA
wire [8:0] n_AAA_sl, n_AAA_fa, n_AAA_fb, n_AAA_fm;

assign n_AAA_sl = (A_dependent && (n_AA_fa > n_AA_ready)) ?
                  n_AA_fa : n_AA_ready;
assign n_AAA_fa = n_AAA_sl + A_lat_ext[2];
assign n_AAA_fb = n_AA_fb;
assign n_AAA_fm = (n_AAA_fa > n_AA_fm) ? n_AAA_fa : n_AA_fm;

// n_AAB
wire [8:0] n_AAB_sl, n_AAB_fa, n_AAB_fb, n_AAB_fm;
...
// n_ABA
wire [8:0] n_ABA_sl, n_ABA_fa, n_ABA_fb, n_ABA_fm;
...
// n_ABB
wire [8:0] n_ABB_sl, n_ABB_fa, n_ABB_fb, n_ABB_fm;

assign n_ABB_sl = (B_dependent && (n_AB_fb > n_AB_ready)) ?
                  n_AB_fb : n_AB_ready;
assign n_ABB_fa = n_AB_fa;
assign n_ABB_fb = n_ABB_sl + B_lat_ext[1];
assign n_ABB_fm = (n_ABB_fb > n_AB_fm) ? n_ABB_fb : n_AB_fm;

// n_BAA
wire [8:0] n_BAA_sl, n_BAA_fa, n_BAA_fb, n_BAA_fm;

assign n_BAA_sl = (A_dependent && (n_BA_fa > n_BA_ready)) ?
                  n_BA_fa : n_BA_ready;
assign n_BAA_fa = n_BAA_sl + A_lat_ext[1];
assign n_BAA_fb = n_BA_fb;
assign n_BAA_fm = (n_BAA_fa > n_BA_fm) ? n_BAA_fa : n_BA_fm;

// n_BAB
wire [8:0] n_BAB_sl, n_BAB_fa, n_BAB_fb, n_BAB_fm;
...
// n_BBA
wire [8:0] n_BBA_sl, n_BBA_fa, n_BBA_fb, n_BBA_fm;
...
// n_BBB
wire [8:0] n_BBB_sl, n_BBB_fa, n_BBB_fb, n_BBB_fm;

assign n_BBB_sl = (B_dependent && (n_BB_fb > n_BB_ready)) ?
                  n_BB_fb : n_BB_ready;
assign n_BBB_fa = n_BB_fa;
assign n_BBB_fb = n_BBB_sl + B_lat_ext[2];
assign n_BBB_fm = (n_BBB_fb > n_BB_fm) ? n_BBB_fb : n_BB_fm;

//////// DEPTH 4 ////////
// depth-3 branches
wire [8:0] n_AAA_ready = n_AAA_sl + 9'd1;
wire [8:0] n_AAB_ready = n_AAB_sl + 9'd1;
wire [8:0] n_ABA_ready = n_ABA_sl + 9'd1;
wire [8:0] n_ABB_ready = n_ABB_sl + 9'd1;
wire [8:0] n_BAA_ready = n_BAA_sl + 9'd1;
wire [8:0] n_BAB_ready = n_BAB_sl + 9'd1;
wire [8:0] n_BBA_ready = n_BBA_sl + 9'd1;
wire [8:0] n_BBB_ready = n_BBB_sl + 9'd1;

// n_AAAA
wire [8:0] n_AAAA_sl, n_AAAA_fa, n_AAAA_fb, n_AAAA_fm;

assign n_AAAA_sl = (A_dependent && (n_AAA_fa > n_AAA_ready)) ?
                   n_AAA_fa : n_AAA_ready;
assign n_AAAA_fa = n_AAAA_sl + A_lat_ext[3];
...
// n_AAAB
wire [8:0] n_AAAB_sl, n_AAAB_fa, n_AAAB_fb, n_AAAB_fm;
...
// n_AABA
wire [8:0] n_AABA_sl, n_AABA_fa, n_AABA_fb, n_AABA_fm;
...
// n_AABB
wire [8:0] n_AABB_sl, n_AABB_fa, n_AABB_fb, n_AABB_fm;
assign n_AABB_sl = (B_dependent && (n_AAB_fb > n_AAB_ready)) ?
                   n_AAB_fb : n_AAB_ready;
assign n_AABB_fa = n_AAB_fa;
assign n_AABB_fb = n_AABB_sl + B_lat_ext[1];
assign n_AABB_fm = (n_AABB_fb > n_AAB_fm) ?
                   n_AABB_fb : n_AAB_fm;


// n_ABAA
wire [8:0] n_ABAA_sl, n_ABAA_fa, n_ABAA_fb, n_ABAA_fm;

assign n_ABAA_sl = (A_dependent && (n_ABA_fa > n_ABA_ready)) ?
                   n_ABA_fa : n_ABA_ready;
assign n_ABAA_fa = n_ABAA_sl + A_lat_ext[2];
...
// n_ABAB
wire [8:0] n_ABAB_sl, n_ABAB_fa, n_ABAB_fb, n_ABAB_fm;
...
// n_ABBA
wire [8:0] n_ABBA_sl, n_ABBA_fa, n_ABBA_fb, n_ABBA_fm;
...
// n_ABBB
wire [8:0] n_ABBB_sl, n_ABBB_fa, n_ABBB_fb, n_ABBB_fm;

assign n_ABBB_sl = (B_dependent && (n_ABB_fb > n_ABB_ready)) ?
                   n_ABB_fb : n_ABB_ready;
assign n_ABBB_fa = n_ABB_fa;
assign n_ABBB_fb = n_ABBB_sl + B_lat_ext[2];
assign n_ABBB_fm = (n_ABBB_fb > n_ABB_fm) ?
                   n_ABBB_fb : n_ABB_fm;


// n_BAAA
wire [8:0] n_BAAA_sl, n_BAAA_fa, n_BAAA_fb, n_BAAA_fm;

assign n_BAAA_sl = (A_dependent && (n_BAA_fa > n_BAA_ready)) ?
                   n_BAA_fa : n_BAA_ready;
assign n_BAAA_fa = n_BAAA_sl + A_lat_ext[2];
...
// n_BAAB
wire [8:0] n_BAAB_sl, n_BAAB_fa, n_BAAB_fb, n_BAAB_fm;
...
// n_BABA
wire [8:0] n_BABA_sl, n_BABA_fa, n_BABA_fb, n_BABA_fm;
...
// n_BABB
wire [8:0] n_BABB_sl, n_BABB_fa, n_BABB_fb, n_BABB_fm;

assign n_BABB_sl = (B_dependent && (n_BAB_fb > n_BAB_ready)) ?
                   n_BAB_fb : n_BAB_ready;
assign n_BABB_fa = n_BAB_fa;
assign n_BABB_fb = n_BABB_sl + B_lat_ext[2];
assign n_BABB_fm = (n_BABB_fb > n_BAB_fm) ?
                   n_BABB_fb : n_BAB_fm;


// n_BBAA
wire [8:0] n_BBAA_sl, n_BBAA_fa, n_BBAA_fb, n_BBAA_fm;

assign n_BBAA_sl = (A_dependent && (n_BBA_fa > n_BBA_ready)) ?
                   n_BBA_fa : n_BBA_ready;
assign n_BBAA_fa = n_BBAA_sl + A_lat_ext[1];
...
// n_BBAB
wire [8:0] n_BBAB_sl, n_BBAB_fa, n_BBAB_fb, n_BBAB_fm;
...
// n_BBBA
wire [8:0] n_BBBA_sl, n_BBBA_fa, n_BBBA_fb, n_BBBA_fm;
...
//////// DEPTH 5 ////////
// depth-4 branches
wire [8:0] n_AAAA_ready = n_AAAA_sl + 9'd1;
wire [8:0] n_AAAB_ready = n_AAAB_sl + 9'd1;
wire [8:0] n_AABA_ready = n_AABA_sl + 9'd1;
wire [8:0] n_AABB_ready = n_AABB_sl + 9'd1;
wire [8:0] n_ABAA_ready = n_ABAA_sl + 9'd1;
wire [8:0] n_ABAB_ready = n_ABAB_sl + 9'd1;
wire [8:0] n_ABBA_ready = n_ABBA_sl + 9'd1;
wire [8:0] n_ABBB_ready = n_ABBB_sl + 9'd1;
wire [8:0] n_BAAA_ready = n_BAAA_sl + 9'd1;
wire [8:0] n_BAAB_ready = n_BAAB_sl + 9'd1;
wire [8:0] n_BABA_ready = n_BABA_sl + 9'd1;
wire [8:0] n_BABB_ready = n_BABB_sl + 9'd1;
wire [8:0] n_BBAA_ready = n_BBAA_sl + 9'd1;
wire [8:0] n_BBAB_ready = n_BBAB_sl + 9'd1;
wire [8:0] n_BBBA_ready = n_BBBA_sl + 9'd1;

// n_AAAAA
wire [8:0] n_AAAAA_sl, n_AAAAA_fa, n_AAAAA_fb, n_AAAAA_fm;
assign n_AAAAA_sl = (A_dependent && (n_AAAA_fa > n_AAAA_ready)) ?
                    n_AAAA_fa : n_AAAA_ready;
assign n_AAAAA_fa = n_AAAAA_sl + A_lat_ext[4];
assign n_AAAAA_fb = n_AAAA_fb;
assign n_AAAAA_fm = (n_AAAAA_fa > n_AAAA_fm) ?
                    n_AAAAA_fa : n_AAAA_fm;

// n_AAAAB
wire [8:0] n_AAAAB_sl, n_AAAAB_fa, n_AAAAB_fb, n_AAAAB_fm;
...
// n_AAABA
wire [8:0] n_AAABA_sl, n_AAABA_fa, n_AAABA_fb, n_AAABA_fm;
...
// n_AAABB
wire [8:0] n_AAABB_sl, n_AAABB_fa, n_AAABB_fb, n_AAABB_fm;
assign n_AAABB_sl = (B_dependent && (n_AAAB_fb > n_AAAB_ready)) ?
                    n_AAAB_fb : n_AAAB_ready;
assign n_AAABB_fa = n_AAAB_fa;
assign n_AAABB_fb = n_AAABB_sl + B_lat_ext[1];
assign n_AAABB_fm = (n_AAABB_fb > n_AAAB_fm) ?
                    n_AAABB_fb : n_AAAB_fm;

// n_AABAA
wire [8:0] n_AABAA_sl, n_AABAA_fa, n_AABAA_fb, n_AABAA_fm;
assign n_AABAA_sl = (A_dependent && (n_AABA_fa > n_AABA_ready)) ?
                    n_AABA_fa : n_AABA_ready;
assign n_AABAA_fa = n_AABAA_sl + A_lat_ext[3];
assign n_AABAA_fb = n_AABA_fb;
assign n_AABAA_fm = (n_AABAA_fa > n_AABA_fm) ?
                    n_AABAA_fa : n_AABA_fm;

// n_AABAB
wire [8:0] n_AABAB_sl, n_AABAB_fa, n_AABAB_fb, n_AABAB_fm;
...
// n_AABBA
wire [8:0] n_AABBA_sl, n_AABBA_fa, n_AABBA_fb, n_AABBA_fm;
...
// n_AABBB
wire [8:0] n_AABBB_sl, n_AABBB_fa, n_AABBB_fb, n_AABBB_fm;
assign n_AABBB_sl = (B_dependent && (n_AABB_fb > n_AABB_ready)) ?
                    n_AABB_fb : n_AABB_ready;
assign n_AABBB_fa = n_AABB_fa;
assign n_AABBB_fb = n_AABBB_sl + B_lat_ext[2];
assign n_AABBB_fm = (n_AABBB_fb > n_AABB_fm) ?
                    n_AABBB_fb : n_AABB_fm;

// n_ABAAA
wire [8:0] n_ABAAA_sl, n_ABAAA_fa, n_ABAAA_fb, n_ABAAA_fm;
assign n_ABAAA_sl = (A_dependent && (n_ABAA_fa > n_ABAA_ready)) ?
                    n_ABAA_fa : n_ABAA_ready;
assign n_ABAAA_fa = n_ABAAA_sl + A_lat_ext[3];
assign n_ABAAA_fb = n_ABAA_fb;
assign n_ABAAA_fm = (n_ABAAA_fa > n_ABAA_fm) ?
                    n_ABAAA_fa : n_ABAA_fm;

// n_ABAAB
wire [8:0] n_ABAAB_sl, n_ABAAB_fa, n_ABAAB_fb, n_ABAAB_fm;
...
// n_ABABA
wire [8:0] n_ABABA_sl, n_ABABA_fa, n_ABABA_fb, n_ABABA_fm;
...
// n_ABABB
wire [8:0] n_ABABB_sl, n_ABABB_fa, n_ABABB_fb, n_ABABB_fm;
assign n_ABABB_sl = (B_dependent && (n_ABAB_fb > n_ABAB_ready)) ?
                    n_ABAB_fb : n_ABAB_ready;
assign n_ABABB_fa = n_ABAB_fa;
assign n_ABABB_fb = n_ABABB_sl + B_lat_ext[2];
assign n_ABABB_fm = (n_ABABB_fb > n_ABAB_fm) ?
                    n_ABABB_fb : n_ABAB_fm;

// n_ABBAA
wire [8:0] n_ABBAA_sl, n_ABBAA_fa, n_ABBAA_fb, n_ABBAA_fm;
assign n_ABBAA_sl = (A_dependent && (n_ABBA_fa > n_ABBA_ready)) ?
                    n_ABBA_fa : n_ABBA_ready;
assign n_ABBAA_fa = n_ABBAA_sl + A_lat_ext[2];
assign n_ABBAA_fb = n_ABBA_fb;
assign n_ABBAA_fm = (n_ABBAA_fa > n_ABBA_fm) ?
                    n_ABBAA_fa : n_ABBA_fm;

// n_ABBAB
wire [8:0] n_ABBAB_sl, n_ABBAB_fa, n_ABBAB_fb, n_ABBAB_fm;
...
// n_ABBBA
wire [8:0] n_ABBBA_sl, n_ABBBA_fa, n_ABBBA_fb, n_ABBBA_fm;
...
// n_BAAAA
wire [8:0] n_BAAAA_sl, n_BAAAA_fa, n_BAAAA_fb, n_BAAAA_fm;
assign n_BAAAA_sl = (A_dependent && (n_BAAA_fa > n_BAAA_ready)) ?
                    n_BAAA_fa : n_BAAA_ready;
assign n_BAAAA_fa = n_BAAAA_sl + A_lat_ext[3];
assign n_BAAAA_fb = n_BAAA_fb;
assign n_BAAAA_fm = (n_BAAAA_fa > n_BAAA_fm) ?
                    n_BAAAA_fa : n_BAAA_fm;

// n_BAAAB
wire [8:0] n_BAAAB_sl, n_BAAAB_fa, n_BAAAB_fb, n_BAAAB_fm;
...
// n_BAABA
wire [8:0] n_BAABA_sl, n_BAABA_fa, n_BAABA_fb, n_BAABA_fm;
...
// n_BAABB
wire [8:0] n_BAABB_sl, n_BAABB_fa, n_BAABB_fb, n_BAABB_fm;
assign n_BAABB_sl = (B_dependent && (n_BAAB_fb > n_BAAB_ready)) ?
                    n_BAAB_fb : n_BAAB_ready;
assign n_BAABB_fa = n_BAAB_fa;
assign n_BAABB_fb = n_BAABB_sl + B_lat_ext[2];
assign n_BAABB_fm = (n_BAABB_fb > n_BAAB_fm) ?
                    n_BAABB_fb : n_BAAB_fm;

// n_BABAA
wire [8:0] n_BABAA_sl, n_BABAA_fa, n_BABAA_fb, n_BABAA_fm;
assign n_BABAA_sl = (A_dependent && (n_BABA_fa > n_BABA_ready)) ?
                    n_BABA_fa : n_BABA_ready;
assign n_BABAA_fa = n_BABAA_sl + A_lat_ext[2];
assign n_BABAA_fb = n_BABA_fb;
assign n_BABAA_fm = (n_BABAA_fa > n_BABA_fm) ?
                    n_BABAA_fa : n_BABA_fm;

// n_BABAB
wire [8:0] n_BABAB_sl, n_BABAB_fa, n_BABAB_fb, n_BABAB_fm;
...
// n_BABBA
wire [8:0] n_BABBA_sl, n_BABBA_fa, n_BABBA_fb, n_BABBA_fm;
...
// n_BBAAA
wire [8:0] n_BBAAA_sl, n_BBAAA_fa, n_BBAAA_fb, n_BBAAA_fm;
assign n_BBAAA_sl = (A_dependent && (n_BBAA_fa > n_BBAA_ready)) ?
                    n_BBAA_fa : n_BBAA_ready;
assign n_BBAAA_fa = n_BBAAA_sl + A_lat_ext[2];
assign n_BBAAA_fb = n_BBAA_fb;
assign n_BBAAA_fm = (n_BBAAA_fa > n_BBAA_fm) ?
                    n_BBAAA_fa : n_BBAA_fm;

// n_BBAAB
wire [8:0] n_BBAAB_sl, n_BBAAB_fa, n_BBAAB_fb, n_BBAAB_fm;
...
// n_BBABA
wire [8:0] n_BBABA_sl, n_BBABA_fa, n_BBABA_fb, n_BBABA_fm;
...
// n_BBBAA
wire [8:0] n_BBBAA_sl, n_BBBAA_fa, n_BBBAA_fb, n_BBBAA_fm;
assign n_BBBAA_sl = (A_dependent && (n_BBBA_fa > n_BBBA_ready)) ?
                    n_BBBA_fa : n_BBBA_ready;
assign n_BBBAA_fa = n_BBBAA_sl + A_lat_ext[1];
...
//////// DEPTH 6 ////////
// depth-5 branches
wire [8:0] n_AAAAA_ready = n_AAAAA_sl + 9'd1;
wire [8:0] n_AAAAB_ready = n_AAAAB_sl + 9'd1;
wire [8:0] n_AAABA_ready = n_AAABA_sl + 9'd1;
wire [8:0] n_AAABB_ready = n_AAABB_sl + 9'd1;
wire [8:0] n_AABAA_ready = n_AABAA_sl + 9'd1;
wire [8:0] n_AABAB_ready = n_AABAB_sl + 9'd1;
wire [8:0] n_AABBA_ready = n_AABBA_sl + 9'd1;
wire [8:0] n_AABBB_ready = n_AABBB_sl + 9'd1;
wire [8:0] n_ABAAA_ready = n_ABAAA_sl + 9'd1;
wire [8:0] n_ABAAB_ready = n_ABAAB_sl + 9'd1;
wire [8:0] n_ABABA_ready = n_ABABA_sl + 9'd1;
wire [8:0] n_ABABB_ready = n_ABABB_sl + 9'd1;
wire [8:0] n_ABBAA_ready = n_ABBAA_sl + 9'd1;
wire [8:0] n_ABBAB_ready = n_ABBAB_sl + 9'd1;
wire [8:0] n_ABBBA_ready = n_ABBBA_sl + 9'd1;
wire [8:0] n_BAAAA_ready = n_BAAAA_sl + 9'd1;
wire [8:0] n_BAAAB_ready = n_BAAAB_sl + 9'd1;
wire [8:0] n_BAABA_ready = n_BAABA_sl + 9'd1;
wire [8:0] n_BAABB_ready = n_BAABB_sl + 9'd1;
wire [8:0] n_BABAA_ready = n_BABAA_sl + 9'd1;
wire [8:0] n_BABAB_ready = n_BABAB_sl + 9'd1;
wire [8:0] n_BABBA_ready = n_BABBA_sl + 9'd1;
wire [8:0] n_BBAAA_ready = n_BBAAA_sl + 9'd1;
wire [8:0] n_BBAAB_ready = n_BBAAB_sl + 9'd1;
wire [8:0] n_BBABA_ready = n_BBABA_sl + 9'd1;
wire [8:0] n_BBBAA_ready = n_BBBAA_sl + 9'd1;

// n_AAAAAA
wire [8:0] n_AAAAAA_sl, n_AAAAAA_fa, n_AAAAAA_fb, n_AAAAAA_fm;
assign n_AAAAAA_sl = (A_dependent && (n_AAAAA_fa > n_AAAAA_ready)) ?
                     n_AAAAA_fa : n_AAAAA_ready;
assign n_AAAAAA_fa = n_AAAAAA_sl + A_lat_ext[5];
assign n_AAAAAA_fb = n_AAAAA_fb;
assign n_AAAAAA_fm = (n_AAAAAA_fa > n_AAAAA_fm) ?
                     n_AAAAAA_fa : n_AAAAA_fm;

// n_AAAAAB
wire [8:0] n_AAAAAB_sl, n_AAAAAB_fa, n_AAAAAB_fb, n_AAAAAB_fm;
...
// n_AAAABA
wire [8:0] n_AAAABA_sl, n_AAAABA_fa, n_AAAABA_fb, n_AAAABA_fm;
...
// n_AAAABB
wire [8:0] n_AAAABB_sl, n_AAAABB_fa, n_AAAABB_fb, n_AAAABB_fm;
assign n_AAAABB_sl = (B_dependent && (n_AAAAB_fb > n_AAAAB_ready)) ?
                     n_AAAAB_fb : n_AAAAB_ready;
assign n_AAAABB_fa = n_AAAAB_fa;
assign n_AAAABB_fb = n_AAAABB_sl + B_lat_ext[1];
assign n_AAAABB_fm = (n_AAAABB_fb > n_AAAAB_fm) ?
                     n_AAAABB_fb : n_AAAAB_fm;

// n_AAABAA
wire [8:0] n_AAABAA_sl, n_AAABAA_fa, n_AAABAA_fb, n_AAABAA_fm;
assign n_AAABAA_sl = (A_dependent && (n_AAABA_fa > n_AAABA_ready)) ?
                     n_AAABA_fa : n_AAABA_ready;
assign n_AAABAA_fa = n_AAABAA_sl + A_lat_ext[4];
assign n_AAABAA_fb = n_AAABA_fb;
assign n_AAABAA_fm = (n_AAABAA_fa > n_AAABA_fm) ?
                     n_AAABAA_fa : n_AAABA_fm;

// n_AAABAB
wire [8:0] n_AAABAB_sl, n_AAABAB_fa, n_AAABAB_fb, n_AAABAB_fm;
...
// n_AAABBA
wire [8:0] n_AAABBA_sl, n_AAABBA_fa, n_AAABBA_fb, n_AAABBA_fm;
...
// n_AAABBB
wire [8:0] n_AAABBB_sl, n_AAABBB_fa, n_AAABBB_fb, n_AAABBB_fm;
assign n_AAABBB_sl = (B_dependent && (n_AAABB_fb > n_AAABB_ready)) ?
                     n_AAABB_fb : n_AAABB_ready;
assign n_AAABBB_fa = n_AAABB_fa;
assign n_AAABBB_fb = n_AAABBB_sl + B_lat_ext[2];
assign n_AAABBB_fm = (n_AAABBB_fb > n_AAABB_fm) ?
                     n_AAABBB_fb : n_AAABB_fm;

// n_AABAAA
wire [8:0] n_AABAAA_sl, n_AABAAA_fa, n_AABAAA_fb, n_AABAAA_fm;
assign n_AABAAA_sl = (A_dependent && (n_AABAA_fa > n_AABAA_ready)) ?
                     n_AABAA_fa : n_AABAA_ready;
assign n_AABAAA_fa = n_AABAAA_sl + A_lat_ext[4];
assign n_AABAAA_fb = n_AABAA_fb;
assign n_AABAAA_fm = (n_AABAAA_fa > n_AABAA_fm) ?
                     n_AABAAA_fa : n_AABAA_fm;

// n_AABAAB
wire [8:0] n_AABAAB_sl, n_AABAAB_fa, n_AABAAB_fb, n_AABAAB_fm;
...
// n_AABABA
wire [8:0] n_AABABA_sl, n_AABABA_fa, n_AABABA_fb, n_AABABA_fm;
...
// n_AABABB
wire [8:0] n_AABABB_sl, n_AABABB_fa, n_AABABB_fb, n_AABABB_fm;
assign n_AABABB_sl = (B_dependent && (n_AABAB_fb > n_AABAB_ready)) ?
                     n_AABAB_fb : n_AABAB_ready;
assign n_AABABB_fa = n_AABAB_fa;
assign n_AABABB_fb = n_AABABB_sl + B_lat_ext[2];
assign n_AABABB_fm = (n_AABABB_fb > n_AABAB_fm) ?
                     n_AABABB_fb : n_AABAB_fm;

// n_AABBAA
wire [8:0] n_AABBAA_sl, n_AABBAA_fa, n_AABBAA_fb, n_AABBAA_fm;
assign n_AABBAA_sl = (A_dependent && (n_AABBA_fa > n_AABBA_ready)) ?
                     n_AABBA_fa : n_AABBA_ready;
assign n_AABBAA_fa = n_AABBAA_sl + A_lat_ext[3];
assign n_AABBAA_fb = n_AABBA_fb;
assign n_AABBAA_fm = (n_AABBAA_fa > n_AABBA_fm) ?
                     n_AABBAA_fa : n_AABBA_fm;

// n_AABBAB
wire [8:0] n_AABBAB_sl, n_AABBAB_fa, n_AABBAB_fb, n_AABBAB_fm;
...
// n_AABBBA
wire [8:0] n_AABBBA_sl, n_AABBBA_fa, n_AABBBA_fb, n_AABBBA_fm;
...
// n_ABAAAA
wire [8:0] n_ABAAAA_sl, n_ABAAAA_fa, n_ABAAAA_fb, n_ABAAAA_fm;
assign n_ABAAAA_sl = (A_dependent && (n_ABAAA_fa > n_ABAAA_ready)) ?
                     n_ABAAA_fa : n_ABAAA_ready;
assign n_ABAAAA_fa = n_ABAAAA_sl + A_lat_ext[4];
assign n_ABAAAA_fb = n_ABAAA_fb;
assign n_ABAAAA_fm = (n_ABAAAA_fa > n_ABAAA_fm) ?
                     n_ABAAAA_fa : n_ABAAA_fm;

// n_ABAAAB
wire [8:0] n_ABAAAB_sl, n_ABAAAB_fa, n_ABAAAB_fb, n_ABAAAB_fm;
...
// n_ABAABA
wire [8:0] n_ABAABA_sl, n_ABAABA_fa, n_ABAABA_fb, n_ABAABA_fm;
...
// n_ABAABB
wire [8:0] n_ABAABB_sl, n_ABAABB_fa, n_ABAABB_fb, n_ABAABB_fm;
assign n_ABAABB_sl = (B_dependent && (n_ABAAB_fb > n_ABAAB_ready)) ?
                     n_ABAAB_fb : n_ABAAB_ready;
assign n_ABAABB_fa = n_ABAAB_fa;
assign n_ABAABB_fb = n_ABAABB_sl + B_lat_ext[2];
assign n_ABAABB_fm = (n_ABAABB_fb > n_ABAAB_fm) ?
                     n_ABAABB_fb : n_ABAAB_fm;

// n_ABABAA
wire [8:0] n_ABABAA_sl, n_ABABAA_fa, n_ABABAA_fb, n_ABABAA_fm;
assign n_ABABAA_sl = (A_dependent && (n_ABABA_fa > n_ABABA_ready)) ?
                     n_ABABA_fa : n_ABABA_ready;
assign n_ABABAA_fa = n_ABABAA_sl + A_lat_ext[3];
assign n_ABABAA_fb = n_ABABA_fb;
assign n_ABABAA_fm = (n_ABABAA_fa > n_ABABA_fm) ?
                     n_ABABAA_fa : n_ABABA_fm;

// n_ABABAB
wire [8:0] n_ABABAB_sl, n_ABABAB_fa, n_ABABAB_fb, n_ABABAB_fm;
...
// n_ABABBA
wire [8:0] n_ABABBA_sl, n_ABABBA_fa, n_ABABBA_fb, n_ABABBA_fm;
...
// n_ABBAAA
wire [8:0] n_ABBAAA_sl, n_ABBAAA_fa, n_ABBAAA_fb, n_ABBAAA_fm;
assign n_ABBAAA_sl = (A_dependent && (n_ABBAA_fa > n_ABBAA_ready)) ?
                     n_ABBAA_fa : n_ABBAA_ready;
assign n_ABBAAA_fa = n_ABBAAA_sl + A_lat_ext[3];
assign n_ABBAAA_fb = n_ABBAA_fb;
assign n_ABBAAA_fm = (n_ABBAAA_fa > n_ABBAA_fm) ?
                     n_ABBAAA_fa : n_ABBAA_fm;

// n_ABBAAB
wire [8:0] n_ABBAAB_sl, n_ABBAAB_fa, n_ABBAAB_fb, n_ABBAAB_fm;
...
// n_ABBABA
wire [8:0] n_ABBABA_sl, n_ABBABA_fa, n_ABBABA_fb, n_ABBABA_fm;
...
// n_ABBBAA
wire [8:0] n_ABBBAA_sl, n_ABBBAA_fa, n_ABBBAA_fb, n_ABBBAA_fm;
assign n_ABBBAA_sl = (A_dependent && (n_ABBBA_fa > n_ABBBA_ready)) ?
                     n_ABBBA_fa : n_ABBBA_ready;
assign n_ABBBAA_fa = n_ABBBAA_sl + A_lat_ext[2];
assign n_ABBBAA_fb = n_ABBBA_fb;
assign n_ABBBAA_fm = (n_ABBBAA_fa > n_ABBBA_fm) ?
                     n_ABBBAA_fa : n_ABBBA_fm;

// n_BAAAAA
wire [8:0] n_BAAAAA_sl, n_BAAAAA_fa, n_BAAAAA_fb, n_BAAAAA_fm;
assign n_BAAAAA_sl = (A_dependent && (n_BAAAA_fa > n_BAAAA_ready)) ?
                     n_BAAAA_fa : n_BAAAA_ready;
assign n_BAAAAA_fa = n_BAAAAA_sl + A_lat_ext[4];
assign n_BAAAAA_fb = n_BAAAA_fb;
assign n_BAAAAA_fm = (n_BAAAAA_fa > n_BAAAA_fm) ?
                     n_BAAAAA_fa : n_BAAAA_fm;

// n_BAAAAB
wire [8:0] n_BAAAAB_sl, n_BAAAAB_fa, n_BAAAAB_fb, n_BAAAAB_fm;
...
// n_BAAABA
wire [8:0] n_BAAABA_sl, n_BAAABA_fa, n_BAAABA_fb, n_BAAABA_fm;
...
// n_BAAABB
wire [8:0] n_BAAABB_sl, n_BAAABB_fa, n_BAAABB_fb, n_BAAABB_fm;
assign n_BAAABB_sl = (B_dependent && (n_BAAAB_fb > n_BAAAB_ready)) ?
                     n_BAAAB_fb : n_BAAAB_ready;
assign n_BAAABB_fa = n_BAAAB_fa;
assign n_BAAABB_fb = n_BAAABB_sl + B_lat_ext[2];
assign n_BAAABB_fm = (n_BAAABB_fb > n_BAAAB_fm) ?
                     n_BAAABB_fb : n_BAAAB_fm;

// n_BAABAA
wire [8:0] n_BAABAA_sl, n_BAABAA_fa, n_BAABAA_fb, n_BAABAA_fm;
assign n_BAABAA_sl = (A_dependent && (n_BAABA_fa > n_BAABA_ready)) ?
                     n_BAABA_fa : n_BAABA_ready;
assign n_BAABAA_fa = n_BAABAA_sl + A_lat_ext[3];
assign n_BAABAA_fb = n_BAABA_fb;
assign n_BAABAA_fm = (n_BAABAA_fa > n_BAABA_fm) ?
                     n_BAABAA_fa : n_BAABA_fm;

// n_BAABAB
wire [8:0] n_BAABAB_sl, n_BAABAB_fa, n_BAABAB_fb, n_BAABAB_fm;
...
// n_BAABBA
wire [8:0] n_BAABBA_sl, n_BAABBA_fa, n_BAABBA_fb, n_BAABBA_fm;
...
// n_BABAAA
wire [8:0] n_BABAAA_sl, n_BABAAA_fa, n_BABAAA_fb, n_BABAAA_fm;
assign n_BABAAA_sl = (A_dependent && (n_BABAA_fa > n_BABAA_ready)) ?
                     n_BABAA_fa : n_BABAA_ready;
assign n_BABAAA_fa = n_BABAAA_sl + A_lat_ext[3];
assign n_BABAAA_fb = n_BABAA_fb;
assign n_BABAAA_fm = (n_BABAAA_fa > n_BABAA_fm) ?
                     n_BABAAA_fa : n_BABAA_fm;

// n_BABAAB
wire [8:0] n_BABAAB_sl, n_BABAAB_fa, n_BABAAB_fb, n_BABAAB_fm;
...
// n_BABABA
wire [8:0] n_BABABA_sl, n_BABABA_fa, n_BABABA_fb, n_BABABA_fm;
...
// n_BABBAA
wire [8:0] n_BABBAA_sl, n_BABBAA_fa, n_BABBAA_fb, n_BABBAA_fm;
assign n_BABBAA_sl = (A_dependent && (n_BABBA_fa > n_BABBA_ready)) ?
                     n_BABBA_fa : n_BABBA_ready;
assign n_BABBAA_fa = n_BABBAA_sl + A_lat_ext[2];
assign n_BABBAA_fb = n_BABBA_fb;
assign n_BABBAA_fm = (n_BABBAA_fa > n_BABBA_fm) ?
                     n_BABBAA_fa : n_BABBA_fm;

// n_BBAAAA
wire [8:0] n_BBAAAA_sl, n_BBAAAA_fa, n_BBAAAA_fb, n_BBAAAA_fm;
assign n_BBAAAA_sl = (A_dependent && (n_BBAAA_fa > n_BBAAA_ready)) ?
                     n_BBAAA_fa : n_BBAAA_ready;
assign n_BBAAAA_fa = n_BBAAAA_sl + A_lat_ext[3];
assign n_BBAAAA_fb = n_BBAAA_fb;
assign n_BBAAAA_fm = (n_BBAAAA_fa > n_BBAAA_fm) ?
                     n_BBAAAA_fa : n_BBAAA_fm;

// n_BBAAAB
wire [8:0] n_BBAAAB_sl, n_BBAAAB_fa, n_BBAAAB_fb, n_BBAAAB_fm;
...
// n_BBAABA
wire [8:0] n_BBAABA_sl, n_BBAABA_fa, n_BBAABA_fb, n_BBAABA_fm;
...
// n_BBABAA
wire [8:0] n_BBABAA_sl, n_BBABAA_fa, n_BBABAA_fb, n_BBABAA_fm;
assign n_BBABAA_sl = (A_dependent && (n_BBABA_fa > n_BBABA_ready)) ?
                     n_BBABA_fa : n_BBABA_ready;
assign n_BBABAA_fa = n_BBABAA_sl + A_lat_ext[2];
assign n_BBABAA_fb = n_BBABA_fb;
assign n_BBABAA_fm = (n_BBABAA_fa > n_BBABA_fm) ?
                     n_BBABAA_fa : n_BBABA_fm;

// n_BBBAAA
wire [8:0] n_BBBAAA_sl, n_BBBAAA_fa, n_BBBAAA_fb, n_BBBAAA_fm;
assign n_BBBAAA_sl = (A_dependent && (n_BBBAA_fa > n_BBBAA_ready)) ?
                     n_BBBAA_fa : n_BBBAA_ready;
assign n_BBBAAA_fa = n_BBBAAA_sl + A_lat_ext[2];
...
//////// DEPTH 7 ////////
// depth-6 branches
wire [8:0] n_AAAAAA_ready = n_AAAAAA_sl + 9'd1;
wire [8:0] n_AAAAAB_ready = n_AAAAAB_sl + 9'd1;
wire [8:0] n_AAAABA_ready = n_AAAABA_sl + 9'd1;
wire [8:0] n_AAAABB_ready = n_AAAABB_sl + 9'd1;
wire [8:0] n_AAABAA_ready = n_AAABAA_sl + 9'd1;
wire [8:0] n_AAABAB_ready = n_AAABAB_sl + 9'd1;
wire [8:0] n_AAABBA_ready = n_AAABBA_sl + 9'd1;
wire [8:0] n_AAABBB_ready = n_AAABBB_sl + 9'd1;
wire [8:0] n_AABAAA_ready = n_AABAAA_sl + 9'd1;
wire [8:0] n_AABAAB_ready = n_AABAAB_sl + 9'd1;
wire [8:0] n_AABABA_ready = n_AABABA_sl + 9'd1;
wire [8:0] n_AABABB_ready = n_AABABB_sl + 9'd1;
wire [8:0] n_AABBAA_ready = n_AABBAA_sl + 9'd1;
wire [8:0] n_AABBAB_ready = n_AABBAB_sl + 9'd1;
wire [8:0] n_AABBBA_ready = n_AABBBA_sl + 9'd1;
wire [8:0] n_ABAAAA_ready = n_ABAAAA_sl + 9'd1;
wire [8:0] n_ABAAAB_ready = n_ABAAAB_sl + 9'd1;
wire [8:0] n_ABAABA_ready = n_ABAABA_sl + 9'd1;
wire [8:0] n_ABAABB_ready = n_ABAABB_sl + 9'd1;
wire [8:0] n_ABABAA_ready = n_ABABAA_sl + 9'd1;
wire [8:0] n_ABABAB_ready = n_ABABAB_sl + 9'd1;
wire [8:0] n_ABABBA_ready = n_ABABBA_sl + 9'd1;
wire [8:0] n_ABBAAA_ready = n_ABBAAA_sl + 9'd1;
wire [8:0] n_ABBAAB_ready = n_ABBAAB_sl + 9'd1;
wire [8:0] n_ABBABA_ready = n_ABBABA_sl + 9'd1;
wire [8:0] n_ABBBAA_ready = n_ABBBAA_sl + 9'd1;
wire [8:0] n_BAAAAA_ready = n_BAAAAA_sl + 9'd1;
wire [8:0] n_BAAAAB_ready = n_BAAAAB_sl + 9'd1;
wire [8:0] n_BAAABA_ready = n_BAAABA_sl + 9'd1;
wire [8:0] n_BAAABB_ready = n_BAAABB_sl + 9'd1;
wire [8:0] n_BAABAA_ready = n_BAABAA_sl + 9'd1;
wire [8:0] n_BAABAB_ready = n_BAABAB_sl + 9'd1;
wire [8:0] n_BAABBA_ready = n_BAABBA_sl + 9'd1;
wire [8:0] n_BABAAA_ready = n_BABAAA_sl + 9'd1;
wire [8:0] n_BABAAB_ready = n_BABAAB_sl + 9'd1;
wire [8:0] n_BABABA_ready = n_BABABA_sl + 9'd1;
wire [8:0] n_BABBAA_ready = n_BABBAA_sl + 9'd1;
wire [8:0] n_BBAAAA_ready = n_BBAAAA_sl + 9'd1;
wire [8:0] n_BBAAAB_ready = n_BBAAAB_sl + 9'd1;
wire [8:0] n_BBAABA_ready = n_BBAABA_sl + 9'd1;
wire [8:0] n_BBABAA_ready = n_BBABAA_sl + 9'd1;
wire [8:0] n_BBBAAA_ready = n_BBBAAA_sl + 9'd1;

// n_AAAAAAA
wire [8:0] n_AAAAAAA_sl, n_AAAAAAA_fa, n_AAAAAAA_fb, n_AAAAAAA_fm;
assign n_AAAAAAA_sl = (A_dependent && (n_AAAAAA_fa > n_AAAAAA_ready)) ?
                     n_AAAAAA_fa : n_AAAAAA_ready;
assign n_AAAAAAA_fa = n_AAAAAAA_sl + A_lat_ext[6];
assign n_AAAAAAA_fb = n_AAAAAA_fb;
assign n_AAAAAAA_fm = (n_AAAAAAA_fa > n_AAAAAA_fm) ?
                     n_AAAAAAA_fa : n_AAAAAA_fm;

// n_AAAAAAB
wire [8:0] n_AAAAAAB_sl, n_AAAAAAB_fa, n_AAAAAAB_fb, n_AAAAAAB_fm;
...
// n_AAAAABA
wire [8:0] n_AAAAABA_sl, n_AAAAABA_fa, n_AAAAABA_fb, n_AAAAABA_fm;
...
// n_AAAAABB
wire [8:0] n_AAAAABB_sl, n_AAAAABB_fa, n_AAAAABB_fb, n_AAAAABB_fm;
assign n_AAAAABB_sl = (B_dependent && (n_AAAAAB_fb > n_AAAAAB_ready)) ?
                     n_AAAAAB_fb : n_AAAAAB_ready;
assign n_AAAAABB_fa = n_AAAAAB_fa;
assign n_AAAAABB_fb = n_AAAAABB_sl + B_lat_ext[1];
assign n_AAAAABB_fm = (n_AAAAABB_fb > n_AAAAAB_fm) ?
                     n_AAAAABB_fb : n_AAAAAB_fm;

// n_AAAABAA
wire [8:0] n_AAAABAA_sl, n_AAAABAA_fa, n_AAAABAA_fb, n_AAAABAA_fm;
assign n_AAAABAA_sl = (A_dependent && (n_AAAABA_fa > n_AAAABA_ready)) ?
                     n_AAAABA_fa : n_AAAABA_ready;
assign n_AAAABAA_fa = n_AAAABAA_sl + A_lat_ext[5];
assign n_AAAABAA_fb = n_AAAABA_fb;
assign n_AAAABAA_fm = (n_AAAABAA_fa > n_AAAABA_fm) ?
                     n_AAAABAA_fa : n_AAAABA_fm;

// n_AAAABAB
wire [8:0] n_AAAABAB_sl, n_AAAABAB_fa, n_AAAABAB_fb, n_AAAABAB_fm;
...
// n_AAAABBA
wire [8:0] n_AAAABBA_sl, n_AAAABBA_fa, n_AAAABBA_fb, n_AAAABBA_fm;
...
// n_AAAABBB
wire [8:0] n_AAAABBB_sl, n_AAAABBB_fa, n_AAAABBB_fb, n_AAAABBB_fm;
assign n_AAAABBB_sl = (B_dependent && (n_AAAABB_fb > n_AAAABB_ready)) ?
                     n_AAAABB_fb : n_AAAABB_ready;
assign n_AAAABBB_fa = n_AAAABB_fa;
assign n_AAAABBB_fb = n_AAAABBB_sl + B_lat_ext[2];
assign n_AAAABBB_fm = (n_AAAABBB_fb > n_AAAABB_fm) ?
                     n_AAAABBB_fb : n_AAAABB_fm;

// n_AAABAAA
wire [8:0] n_AAABAAA_sl, n_AAABAAA_fa, n_AAABAAA_fb, n_AAABAAA_fm;
assign n_AAABAAA_sl = (A_dependent && (n_AAABAA_fa > n_AAABAA_ready)) ?
                     n_AAABAA_fa : n_AAABAA_ready;
assign n_AAABAAA_fa = n_AAABAAA_sl + A_lat_ext[5];
assign n_AAABAAA_fb = n_AAABAA_fb;
assign n_AAABAAA_fm = (n_AAABAAA_fa > n_AAABAA_fm) ?
                     n_AAABAAA_fa : n_AAABAA_fm;

// n_AAABAAB
wire [8:0] n_AAABAAB_sl, n_AAABAAB_fa, n_AAABAAB_fb, n_AAABAAB_fm;
...
// n_AAABABA
wire [8:0] n_AAABABA_sl, n_AAABABA_fa, n_AAABABA_fb, n_AAABABA_fm;
...
// n_AAABABB
wire [8:0] n_AAABABB_sl, n_AAABABB_fa, n_AAABABB_fb, n_AAABABB_fm;
assign n_AAABABB_sl = (B_dependent && (n_AAABAB_fb > n_AAABAB_ready)) ?
                     n_AAABAB_fb : n_AAABAB_ready;
assign n_AAABABB_fa = n_AAABAB_fa;
assign n_AAABABB_fb = n_AAABABB_sl + B_lat_ext[2];
assign n_AAABABB_fm = (n_AAABABB_fb > n_AAABAB_fm) ?
                     n_AAABABB_fb : n_AAABAB_fm;

// n_AAABBAA
wire [8:0] n_AAABBAA_sl, n_AAABBAA_fa, n_AAABBAA_fb, n_AAABBAA_fm;
assign n_AAABBAA_sl = (A_dependent && (n_AAABBA_fa > n_AAABBA_ready)) ?
                     n_AAABBA_fa : n_AAABBA_ready;
assign n_AAABBAA_fa = n_AAABBAA_sl + A_lat_ext[4];
assign n_AAABBAA_fb = n_AAABBA_fb;
assign n_AAABBAA_fm = (n_AAABBAA_fa > n_AAABBA_fm) ?
                     n_AAABBAA_fa : n_AAABBA_fm;

// n_AAABBAB
wire [8:0] n_AAABBAB_sl, n_AAABBAB_fa, n_AAABBAB_fb, n_AAABBAB_fm;
...
// n_AAABBBA
wire [8:0] n_AAABBBA_sl, n_AAABBBA_fa, n_AAABBBA_fb, n_AAABBBA_fm;
...
// n_AABAAAA
wire [8:0] n_AABAAAA_sl, n_AABAAAA_fa, n_AABAAAA_fb, n_AABAAAA_fm;
assign n_AABAAAA_sl = (A_dependent && (n_AABAAA_fa > n_AABAAA_ready)) ?
                     n_AABAAA_fa : n_AABAAA_ready;
assign n_AABAAAA_fa = n_AABAAAA_sl + A_lat_ext[5];
assign n_AABAAAA_fb = n_AABAAA_fb;
assign n_AABAAAA_fm = (n_AABAAAA_fa > n_AABAAA_fm) ?
                     n_AABAAAA_fa : n_AABAAA_fm;

// n_AABAAAB
wire [8:0] n_AABAAAB_sl, n_AABAAAB_fa, n_AABAAAB_fb, n_AABAAAB_fm;
...
// n_AABAABA
wire [8:0] n_AABAABA_sl, n_AABAABA_fa, n_AABAABA_fb, n_AABAABA_fm;
...
// n_AABAABB
wire [8:0] n_AABAABB_sl, n_AABAABB_fa, n_AABAABB_fb, n_AABAABB_fm;
assign n_AABAABB_sl = (B_dependent && (n_AABAAB_fb > n_AABAAB_ready)) ?
                     n_AABAAB_fb : n_AABAAB_ready;
assign n_AABAABB_fa = n_AABAAB_fa;
assign n_AABAABB_fb = n_AABAABB_sl + B_lat_ext[2];
assign n_AABAABB_fm = (n_AABAABB_fb > n_AABAAB_fm) ?
                     n_AABAABB_fb : n_AABAAB_fm;

// n_AABABAA
wire [8:0] n_AABABAA_sl, n_AABABAA_fa, n_AABABAA_fb, n_AABABAA_fm;
assign n_AABABAA_sl = (A_dependent && (n_AABABA_fa > n_AABABA_ready)) ?
                     n_AABABA_fa : n_AABABA_ready;
assign n_AABABAA_fa = n_AABABAA_sl + A_lat_ext[4];
assign n_AABABAA_fb = n_AABABA_fb;
assign n_AABABAA_fm = (n_AABABAA_fa > n_AABABA_fm) ?
                     n_AABABAA_fa : n_AABABA_fm;

// n_AABABAB
wire [8:0] n_AABABAB_sl, n_AABABAB_fa, n_AABABAB_fb, n_AABABAB_fm;
...
// n_AABABBA
wire [8:0] n_AABABBA_sl, n_AABABBA_fa, n_AABABBA_fb, n_AABABBA_fm;
...
// n_AABBAAA
wire [8:0] n_AABBAAA_sl, n_AABBAAA_fa, n_AABBAAA_fb, n_AABBAAA_fm;
assign n_AABBAAA_sl = (A_dependent && (n_AABBAA_fa > n_AABBAA_ready)) ?
                     n_AABBAA_fa : n_AABBAA_ready;
assign n_AABBAAA_fa = n_AABBAAA_sl + A_lat_ext[4];
assign n_AABBAAA_fb = n_AABBAA_fb;
assign n_AABBAAA_fm = (n_AABBAAA_fa > n_AABBAA_fm) ?
                     n_AABBAAA_fa : n_AABBAA_fm;

// n_AABBAAB
wire [8:0] n_AABBAAB_sl, n_AABBAAB_fa, n_AABBAAB_fb, n_AABBAAB_fm;
...
// n_AABBABA
wire [8:0] n_AABBABA_sl, n_AABBABA_fa, n_AABBABA_fb, n_AABBABA_fm;
...
// n_AABBBAA
wire [8:0] n_AABBBAA_sl, n_AABBBAA_fa, n_AABBBAA_fb, n_AABBBAA_fm;
assign n_AABBBAA_sl = (A_dependent && (n_AABBBA_fa > n_AABBBA_ready)) ?
                     n_AABBBA_fa : n_AABBBA_ready;
assign n_AABBBAA_fa = n_AABBBAA_sl + A_lat_ext[3];
assign n_AABBBAA_fb = n_AABBBA_fb;
assign n_AABBBAA_fm = (n_AABBBAA_fa > n_AABBBA_fm) ?
                     n_AABBBAA_fa : n_AABBBA_fm;

// n_ABAAAAA
wire [8:0] n_ABAAAAA_sl, n_ABAAAAA_fa, n_ABAAAAA_fb, n_ABAAAAA_fm;
assign n_ABAAAAA_sl = (A_dependent && (n_ABAAAA_fa > n_ABAAAA_ready)) ?
                     n_ABAAAA_fa : n_ABAAAA_ready;
assign n_ABAAAAA_fa = n_ABAAAAA_sl + A_lat_ext[5];
assign n_ABAAAAA_fb = n_ABAAAA_fb;
assign n_ABAAAAA_fm = (n_ABAAAAA_fa > n_ABAAAA_fm) ?
                     n_ABAAAAA_fa : n_ABAAAA_fm;

// n_ABAAAAB
wire [8:0] n_ABAAAAB_sl, n_ABAAAAB_fa, n_ABAAAAB_fb, n_ABAAAAB_fm;
...
// n_ABAAABA
wire [8:0] n_ABAAABA_sl, n_ABAAABA_fa, n_ABAAABA_fb, n_ABAAABA_fm;
...
// n_ABAAABB
wire [8:0] n_ABAAABB_sl, n_ABAAABB_fa, n_ABAAABB_fb, n_ABAAABB_fm;
assign n_ABAAABB_sl = (B_dependent && (n_ABAAAB_fb > n_ABAAAB_ready)) ?
                     n_ABAAAB_fb : n_ABAAAB_ready;
assign n_ABAAABB_fa = n_ABAAAB_fa;
assign n_ABAAABB_fb = n_ABAAABB_sl + B_lat_ext[2];
assign n_ABAAABB_fm = (n_ABAAABB_fb > n_ABAAAB_fm) ?
                     n_ABAAABB_fb : n_ABAAAB_fm;

// n_ABAABAA
wire [8:0] n_ABAABAA_sl, n_ABAABAA_fa, n_ABAABAA_fb, n_ABAABAA_fm;
assign n_ABAABAA_sl = (A_dependent && (n_ABAABA_fa > n_ABAABA_ready)) ?
                     n_ABAABA_fa : n_ABAABA_ready;
assign n_ABAABAA_fa = n_ABAABAA_sl + A_lat_ext[4];
assign n_ABAABAA_fb = n_ABAABA_fb;
assign n_ABAABAA_fm = (n_ABAABAA_fa > n_ABAABA_fm) ?
                     n_ABAABAA_fa : n_ABAABA_fm;

// n_ABAABAB
wire [8:0] n_ABAABAB_sl, n_ABAABAB_fa, n_ABAABAB_fb, n_ABAABAB_fm;
...
// n_ABAABBA
wire [8:0] n_ABAABBA_sl, n_ABAABBA_fa, n_ABAABBA_fb, n_ABAABBA_fm;
...
// n_ABABAAA
wire [8:0] n_ABABAAA_sl, n_ABABAAA_fa, n_ABABAAA_fb, n_ABABAAA_fm;
assign n_ABABAAA_sl = (A_dependent && (n_ABABAA_fa > n_ABABAA_ready)) ?
                     n_ABABAA_fa : n_ABABAA_ready;
assign n_ABABAAA_fa = n_ABABAAA_sl + A_lat_ext[4];
assign n_ABABAAA_fb = n_ABABAA_fb;
assign n_ABABAAA_fm = (n_ABABAAA_fa > n_ABABAA_fm) ?
                     n_ABABAAA_fa : n_ABABAA_fm;

// n_ABABAAB
wire [8:0] n_ABABAAB_sl, n_ABABAAB_fa, n_ABABAAB_fb, n_ABABAAB_fm;
...
// n_ABABABA
wire [8:0] n_ABABABA_sl, n_ABABABA_fa, n_ABABABA_fb, n_ABABABA_fm;
...
// n_ABABBAA
wire [8:0] n_ABABBAA_sl, n_ABABBAA_fa, n_ABABBAA_fb, n_ABABBAA_fm;
assign n_ABABBAA_sl = (A_dependent && (n_ABABBA_fa > n_ABABBA_ready)) ?
                     n_ABABBA_fa : n_ABABBA_ready;
assign n_ABABBAA_fa = n_ABABBAA_sl + A_lat_ext[3];
assign n_ABABBAA_fb = n_ABABBA_fb;
assign n_ABABBAA_fm = (n_ABABBAA_fa > n_ABABBA_fm) ?
                     n_ABABBAA_fa : n_ABABBA_fm;

// n_ABBAAAA
wire [8:0] n_ABBAAAA_sl, n_ABBAAAA_fa, n_ABBAAAA_fb, n_ABBAAAA_fm;
assign n_ABBAAAA_sl = (A_dependent && (n_ABBAAA_fa > n_ABBAAA_ready)) ?
                     n_ABBAAA_fa : n_ABBAAA_ready;
assign n_ABBAAAA_fa = n_ABBAAAA_sl + A_lat_ext[4];
assign n_ABBAAAA_fb = n_ABBAAA_fb;
assign n_ABBAAAA_fm = (n_ABBAAAA_fa > n_ABBAAA_fm) ?
                     n_ABBAAAA_fa : n_ABBAAA_fm;

// n_ABBAAAB
wire [8:0] n_ABBAAAB_sl, n_ABBAAAB_fa, n_ABBAAAB_fb, n_ABBAAAB_fm;
...
// n_ABBAABA
wire [8:0] n_ABBAABA_sl, n_ABBAABA_fa, n_ABBAABA_fb, n_ABBAABA_fm;
...
// n_ABBABAA
wire [8:0] n_ABBABAA_sl, n_ABBABAA_fa, n_ABBABAA_fb, n_ABBABAA_fm;
assign n_ABBABAA_sl = (A_dependent && (n_ABBABA_fa > n_ABBABA_ready)) ?
                     n_ABBABA_fa : n_ABBABA_ready;
assign n_ABBABAA_fa = n_ABBABAA_sl + A_lat_ext[3];
assign n_ABBABAA_fb = n_ABBABA_fb;
assign n_ABBABAA_fm = (n_ABBABAA_fa > n_ABBABA_fm) ?
                     n_ABBABAA_fa : n_ABBABA_fm;

// n_ABBBAAA
wire [8:0] n_ABBBAAA_sl, n_ABBBAAA_fa, n_ABBBAAA_fb, n_ABBBAAA_fm;
assign n_ABBBAAA_sl = (A_dependent && (n_ABBBAA_fa > n_ABBBAA_ready)) ?
                     n_ABBBAA_fa : n_ABBBAA_ready;
assign n_ABBBAAA_fa = n_ABBBAAA_sl + A_lat_ext[3];
assign n_ABBBAAA_fb = n_ABBBAA_fb;
assign n_ABBBAAA_fm = (n_ABBBAAA_fa > n_ABBBAA_fm) ?
                     n_ABBBAAA_fa : n_ABBBAA_fm;

// n_BAAAAAA
wire [8:0] n_BAAAAAA_sl, n_BAAAAAA_fa, n_BAAAAAA_fb, n_BAAAAAA_fm;
assign n_BAAAAAA_sl = (A_dependent && (n_BAAAAA_fa > n_BAAAAA_ready)) ?
                     n_BAAAAA_fa : n_BAAAAA_ready;
assign n_BAAAAAA_fa = n_BAAAAAA_sl + A_lat_ext[5];
assign n_BAAAAAA_fb = n_BAAAAA_fb;
assign n_BAAAAAA_fm = (n_BAAAAAA_fa > n_BAAAAA_fm) ?
                     n_BAAAAAA_fa : n_BAAAAA_fm;

// n_BAAAAAB
wire [8:0] n_BAAAAAB_sl, n_BAAAAAB_fa, n_BAAAAAB_fb, n_BAAAAAB_fm;
...
// n_BAAAABA
wire [8:0] n_BAAAABA_sl, n_BAAAABA_fa, n_BAAAABA_fb, n_BAAAABA_fm;
...
// n_BAAAABB
wire [8:0] n_BAAAABB_sl, n_BAAAABB_fa, n_BAAAABB_fb, n_BAAAABB_fm;
assign n_BAAAABB_sl = (B_dependent && (n_BAAAAB_fb > n_BAAAAB_ready)) ?
                     n_BAAAAB_fb : n_BAAAAB_ready;
assign n_BAAAABB_fa = n_BAAAAB_fa;
assign n_BAAAABB_fb = n_BAAAABB_sl + B_lat_ext[2];
assign n_BAAAABB_fm = (n_BAAAABB_fb > n_BAAAAB_fm) ?
                     n_BAAAABB_fb : n_BAAAAB_fm;

// n_BAAABAA
wire [8:0] n_BAAABAA_sl, n_BAAABAA_fa, n_BAAABAA_fb, n_BAAABAA_fm;
assign n_BAAABAA_sl = (A_dependent && (n_BAAABA_fa > n_BAAABA_ready)) ?
                     n_BAAABA_fa : n_BAAABA_ready;
assign n_BAAABAA_fa = n_BAAABAA_sl + A_lat_ext[4];
assign n_BAAABAA_fb = n_BAAABA_fb;
assign n_BAAABAA_fm = (n_BAAABAA_fa > n_BAAABA_fm) ?
                     n_BAAABAA_fa : n_BAAABA_fm;

// n_BAAABAB
wire [8:0] n_BAAABAB_sl, n_BAAABAB_fa, n_BAAABAB_fb, n_BAAABAB_fm;
...
// n_BAAABBA
wire [8:0] n_BAAABBA_sl, n_BAAABBA_fa, n_BAAABBA_fb, n_BAAABBA_fm;
...
// n_BAABAAA
wire [8:0] n_BAABAAA_sl, n_BAABAAA_fa, n_BAABAAA_fb, n_BAABAAA_fm;
assign n_BAABAAA_sl = (A_dependent && (n_BAABAA_fa > n_BAABAA_ready)) ?
                     n_BAABAA_fa : n_BAABAA_ready;
assign n_BAABAAA_fa = n_BAABAAA_sl + A_lat_ext[4];
assign n_BAABAAA_fb = n_BAABAA_fb;
assign n_BAABAAA_fm = (n_BAABAAA_fa > n_BAABAA_fm) ?
                     n_BAABAAA_fa : n_BAABAA_fm;

// n_BAABAAB
wire [8:0] n_BAABAAB_sl, n_BAABAAB_fa, n_BAABAAB_fb, n_BAABAAB_fm;
...
// n_BAABABA
wire [8:0] n_BAABABA_sl, n_BAABABA_fa, n_BAABABA_fb, n_BAABABA_fm;
...
// n_BAABBAA
wire [8:0] n_BAABBAA_sl, n_BAABBAA_fa, n_BAABBAA_fb, n_BAABBAA_fm;
assign n_BAABBAA_sl = (A_dependent && (n_BAABBA_fa > n_BAABBA_ready)) ?
                     n_BAABBA_fa : n_BAABBA_ready;
assign n_BAABBAA_fa = n_BAABBAA_sl + A_lat_ext[3];
assign n_BAABBAA_fb = n_BAABBA_fb;
assign n_BAABBAA_fm = (n_BAABBAA_fa > n_BAABBA_fm) ?
                     n_BAABBAA_fa : n_BAABBA_fm;

// n_BABAAAA
wire [8:0] n_BABAAAA_sl, n_BABAAAA_fa, n_BABAAAA_fb, n_BABAAAA_fm;
assign n_BABAAAA_sl = (A_dependent && (n_BABAAA_fa > n_BABAAA_ready)) ?
                     n_BABAAA_fa : n_BABAAA_ready;
assign n_BABAAAA_fa = n_BABAAAA_sl + A_lat_ext[4];
assign n_BABAAAA_fb = n_BABAAA_fb;
assign n_BABAAAA_fm = (n_BABAAAA_fa > n_BABAAA_fm) ?
                     n_BABAAAA_fa : n_BABAAA_fm;

// n_BABAAAB
wire [8:0] n_BABAAAB_sl, n_BABAAAB_fa, n_BABAAAB_fb, n_BABAAAB_fm;
...
// n_BABAABA
wire [8:0] n_BABAABA_sl, n_BABAABA_fa, n_BABAABA_fb, n_BABAABA_fm;
...
// n_BABABAA
wire [8:0] n_BABABAA_sl, n_BABABAA_fa, n_BABABAA_fb, n_BABABAA_fm;
assign n_BABABAA_sl = (A_dependent && (n_BABABA_fa > n_BABABA_ready)) ?
                     n_BABABA_fa : n_BABABA_ready;
assign n_BABABAA_fa = n_BABABAA_sl + A_lat_ext[3];
assign n_BABABAA_fb = n_BABABA_fb;
assign n_BABABAA_fm = (n_BABABAA_fa > n_BABABA_fm) ?
                     n_BABABAA_fa : n_BABABA_fm;

// n_BABBAAA
wire [8:0] n_BABBAAA_sl, n_BABBAAA_fa, n_BABBAAA_fb, n_BABBAAA_fm;
assign n_BABBAAA_sl = (A_dependent && (n_BABBAA_fa > n_BABBAA_ready)) ?
                     n_BABBAA_fa : n_BABBAA_ready;
assign n_BABBAAA_fa = n_BABBAAA_sl + A_lat_ext[3];
assign n_BABBAAA_fb = n_BABBAA_fb;
assign n_BABBAAA_fm = (n_BABBAAA_fa > n_BABBAA_fm) ?
                     n_BABBAAA_fa : n_BABBAA_fm;

// n_BBAAAAA
wire [8:0] n_BBAAAAA_sl, n_BBAAAAA_fa, n_BBAAAAA_fb, n_BBAAAAA_fm;
assign n_BBAAAAA_sl = (A_dependent && (n_BBAAAA_fa > n_BBAAAA_ready)) ?
                     n_BBAAAA_fa : n_BBAAAA_ready;
assign n_BBAAAAA_fa = n_BBAAAAA_sl + A_lat_ext[4];
assign n_BBAAAAA_fb = n_BBAAAA_fb;
assign n_BBAAAAA_fm = (n_BBAAAAA_fa > n_BBAAAA_fm) ?
                     n_BBAAAAA_fa : n_BBAAAA_fm;

// n_BBAAAAB
wire [8:0] n_BBAAAAB_sl, n_BBAAAAB_fa, n_BBAAAAB_fb, n_BBAAAAB_fm;
...
// n_BBAAABA
wire [8:0] n_BBAAABA_sl, n_BBAAABA_fa, n_BBAAABA_fb, n_BBAAABA_fm;
...
// n_BBAABAA
wire [8:0] n_BBAABAA_sl, n_BBAABAA_fa, n_BBAABAA_fb, n_BBAABAA_fm;
assign n_BBAABAA_sl = (A_dependent && (n_BBAABA_fa > n_BBAABA_ready)) ?
                     n_BBAABA_fa : n_BBAABA_ready;
assign n_BBAABAA_fa = n_BBAABAA_sl + A_lat_ext[3];
assign n_BBAABAA_fb = n_BBAABA_fb;
assign n_BBAABAA_fm = (n_BBAABAA_fa > n_BBAABA_fm) ?
                     n_BBAABAA_fa : n_BBAABA_fm;

// n_BBABAAA
wire [8:0] n_BBABAAA_sl, n_BBABAAA_fa, n_BBABAAA_fb, n_BBABAAA_fm;
assign n_BBABAAA_sl = (A_dependent && (n_BBABAA_fa > n_BBABAA_ready)) ?
                     n_BBABAA_fa : n_BBABAA_ready;
assign n_BBABAAA_fa = n_BBABAAA_sl + A_lat_ext[3];
assign n_BBABAAA_fb = n_BBABAA_fb;
assign n_BBABAAA_fm = (n_BBABAAA_fa > n_BBABAA_fm) ?
                     n_BBABAAA_fa : n_BBABAA_fm;

// n_BBBAAAA
wire [8:0] n_BBBAAAA_sl, n_BBBAAAA_fa, n_BBBAAAA_fb, n_BBBAAAA_fm;
assign n_BBBAAAA_sl = (A_dependent && (n_BBBAAA_fa > n_BBBAAA_ready)) ?
                     n_BBBAAA_fa : n_BBBAAA_ready;
assign n_BBBAAAA_fa = n_BBBAAAA_sl + A_lat_ext[3];
