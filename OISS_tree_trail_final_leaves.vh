...
// B_len == 4 is observed only when A is a dependent group:
// either two 4-entry chains, or a 4-entry chain selected ahead of four
// independent instructions by the A/B tie-break rule.  The leading A tail
// can therefore be collapsed with shared suffix sums.
wire [8:0] A_tail_sum_3   = {3'b000, A_rev_lat[3]};
wire [8:0] A_tail_sum_2   = {3'b000, A_rev_lat[2]} + A_tail_sum_3;
wire [8:0] A_tail_sum_1   = {3'b000, A_rev_lat[1]} + A_tail_sum_2;
wire [8:0] A_tail_sum_0   = {3'b000, A_rev_lat[0]} + A_tail_sum_1;
wire [8:0] A_tail_after_3 = 9'd1;
wire [8:0] A_tail_after_2 = A_tail_sum_3 + 9'd1;
wire [8:0] A_tail_after_1 = A_tail_sum_2 + 9'd1;
wire [8:0] A_tail_after_0 = A_tail_sum_1 + 9'd1;


// l44_AAAABBBB_cycle
wire [7:0] t_AAAABBBB_b4_path = bw_BBB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AAAABBBB_a_tail_issue = t_AAAABBBB_b4_rb + A_tail_after_0;
wire [8:0] t_AAAABBBB_a_tail_dep = t_AAAABBBB_b4_ra + A_tail_sum_0;
wire [8:0] l44_AAAABBBB_cycle = (t_AAAABBBB_a_tail_issue > t_AAAABBBB_a_tail_dep) ? t_AAAABBBB_a_tail_issue : t_AAAABBBB_a_tail_dep;
...
wire [8:0] t_AAABABBB_a_tail_issue = t_AAABABBB_b4_rb + A_tail_after_1;
wire [8:0] t_AAABABBB_a_tail_dep = t_AAABABBB_b4_ra + A_tail_sum_1;
wire [8:0] l44_AAABABBB_cycle = (t_AAABABBB_a_tail_issue > t_AAABABBB_a_tail_dep) ? t_AAABABBB_a_tail_issue : t_AAABABBB_a_tail_dep;

// l44_AAABBABB_cycle
wire [7:0] t_AAABBABB_b4_path = bw_BABB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AAABBABB_a_tail_issue = t_AAABBABB_b4_rb + A_tail_after_1;
wire [8:0] t_AAABBABB_a_tail_dep = t_AAABBABB_b4_ra + A_tail_sum_1;
wire [8:0] l44_AAABBABB_cycle = (t_AAABBABB_a_tail_issue > t_AAABBABB_a_tail_dep) ? t_AAABBABB_a_tail_issue : t_AAABBABB_a_tail_dep;

// l44_AAABBBAB_cycle
wire [7:0] t_AAABBBAB_b4_path = bw_BBAB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AAABBBAB_a_tail_issue = t_AAABBBAB_b4_rb + A_tail_after_1;
wire [8:0] t_AAABBBAB_a_tail_dep = t_AAABBBAB_b4_ra + A_tail_sum_1;
wire [8:0] l44_AAABBBAB_cycle = (t_AAABBBAB_a_tail_issue > t_AAABBBAB_a_tail_dep) ? t_AAABBBAB_a_tail_issue : t_AAABBBAB_a_tail_dep;

// l44_AAABBBBA_cycle
wire [7:0] t_AAABBBBA_b4_path = bw_BBBA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AAABBBBA_a_tail_issue = t_AAABBBBA_b4_rb + A_tail_after_1;
wire [8:0] t_AAABBBBA_a_tail_dep = t_AAABBBBA_b4_ra + A_tail_sum_1;
wire [8:0] l44_AAABBBBA_cycle = (t_AAABBBBA_a_tail_issue > t_AAABBBBA_a_tail_dep) ? t_AAABBBBA_a_tail_issue : t_AAABBBBA_a_tail_dep;
...
wire [8:0] t_AABAABBB_a_tail_issue = t_AABAABBB_b4_rb + A_tail_after_2;
wire [8:0] t_AABAABBB_a_tail_dep = t_AABAABBB_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABAABBB_cycle = (t_AABAABBB_a_tail_issue > t_AABAABBB_a_tail_dep) ? t_AABAABBB_a_tail_issue : t_AABAABBB_a_tail_dep;
...
wire [8:0] t_AABABABB_a_tail_issue = t_AABABABB_b4_rb + A_tail_after_2;
wire [8:0] t_AABABABB_a_tail_dep = t_AABABABB_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABABABB_cycle = (t_AABABABB_a_tail_issue > t_AABABABB_a_tail_dep) ? t_AABABABB_a_tail_issue : t_AABABABB_a_tail_dep;
...
wire [8:0] t_AABABBAB_a_tail_issue = t_AABABBAB_b4_rb + A_tail_after_2;
wire [8:0] t_AABABBAB_a_tail_dep = t_AABABBAB_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABABBAB_cycle = (t_AABABBAB_a_tail_issue > t_AABABBAB_a_tail_dep) ? t_AABABBAB_a_tail_issue : t_AABABBAB_a_tail_dep;
...
wire [8:0] t_AABABBBA_a_tail_issue = t_AABABBBA_b4_rb + A_tail_after_2;
wire [8:0] t_AABABBBA_a_tail_dep = t_AABABBBA_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABABBBA_cycle = (t_AABABBBA_a_tail_issue > t_AABABBBA_a_tail_dep) ? t_AABABBBA_a_tail_issue : t_AABABBBA_a_tail_dep;

// l44_AABBAABB_cycle
wire [7:0] t_AABBAABB_b4_path = bw_BAABB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AABBAABB_a_tail_issue = t_AABBAABB_b4_rb + A_tail_after_2;
wire [8:0] t_AABBAABB_a_tail_dep = t_AABBAABB_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABBAABB_cycle = (t_AABBAABB_a_tail_issue > t_AABBAABB_a_tail_dep) ? t_AABBAABB_a_tail_issue : t_AABBAABB_a_tail_dep;

// l44_AABBABAB_cycle
wire [7:0] t_AABBABAB_b4_path = bw_BABAB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AABBABAB_a_tail_issue = t_AABBABAB_b4_rb + A_tail_after_2;
wire [8:0] t_AABBABAB_a_tail_dep = t_AABBABAB_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABBABAB_cycle = (t_AABBABAB_a_tail_issue > t_AABBABAB_a_tail_dep) ? t_AABBABAB_a_tail_issue : t_AABBABAB_a_tail_dep;

// l44_AABBABBA_cycle
wire [7:0] t_AABBABBA_b4_path = bw_BABBA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AABBABBA_a_tail_issue = t_AABBABBA_b4_rb + A_tail_after_2;
wire [8:0] t_AABBABBA_a_tail_dep = t_AABBABBA_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABBABBA_cycle = (t_AABBABBA_a_tail_issue > t_AABBABBA_a_tail_dep) ? t_AABBABBA_a_tail_issue : t_AABBABBA_a_tail_dep;

// l44_AABBBAAB_cycle
wire [7:0] t_AABBBAAB_b4_path = bw_BBAAB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AABBBAAB_a_tail_issue = t_AABBBAAB_b4_rb + A_tail_after_2;
wire [8:0] t_AABBBAAB_a_tail_dep = t_AABBBAAB_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABBBAAB_cycle = (t_AABBBAAB_a_tail_issue > t_AABBBAAB_a_tail_dep) ? t_AABBBAAB_a_tail_issue : t_AABBBAAB_a_tail_dep;

// l44_AABBBABA_cycle
wire [7:0] t_AABBBABA_b4_path = bw_BBABA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AABBBABA_a_tail_issue = t_AABBBABA_b4_rb + A_tail_after_2;
wire [8:0] t_AABBBABA_a_tail_dep = t_AABBBABA_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABBBABA_cycle = (t_AABBBABA_a_tail_issue > t_AABBBABA_a_tail_dep) ? t_AABBBABA_a_tail_issue : t_AABBBABA_a_tail_dep;

// l44_AABBBBAA_cycle
wire [7:0] t_AABBBBAA_b4_path = bw_BBBAA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_AABBBBAA_a_tail_issue = t_AABBBBAA_b4_rb + A_tail_after_2;
wire [8:0] t_AABBBBAA_a_tail_dep = t_AABBBBAA_b4_ra + A_tail_sum_2;
wire [8:0] l44_AABBBBAA_cycle = (t_AABBBBAA_a_tail_issue > t_AABBBBAA_a_tail_dep) ? t_AABBBBAA_a_tail_issue : t_AABBBBAA_a_tail_dep;
...
wire [8:0] t_ABAAABBB_a_tail_issue = t_ABAAABBB_b4_rb + A_tail_after_3;
wire [8:0] t_ABAAABBB_a_tail_dep = t_ABAAABBB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABAAABBB_cycle = (t_ABAAABBB_a_tail_issue > t_ABAAABBB_a_tail_dep) ? t_ABAAABBB_a_tail_issue : t_ABAAABBB_a_tail_dep;
...
wire [8:0] t_ABAABABB_a_tail_issue = t_ABAABABB_b4_rb + A_tail_after_3;
wire [8:0] t_ABAABABB_a_tail_dep = t_ABAABABB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABAABABB_cycle = (t_ABAABABB_a_tail_issue > t_ABAABABB_a_tail_dep) ? t_ABAABABB_a_tail_issue : t_ABAABABB_a_tail_dep;
...
wire [8:0] t_ABAABBAB_a_tail_issue = t_ABAABBAB_b4_rb + A_tail_after_3;
wire [8:0] t_ABAABBAB_a_tail_dep = t_ABAABBAB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABAABBAB_cycle = (t_ABAABBAB_a_tail_issue > t_ABAABBAB_a_tail_dep) ? t_ABAABBAB_a_tail_issue : t_ABAABBAB_a_tail_dep;
...
wire [8:0] t_ABAABBBA_a_tail_issue = t_ABAABBBA_b4_rb + A_tail_after_3;
wire [8:0] t_ABAABBBA_a_tail_dep = t_ABAABBBA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABAABBBA_cycle = (t_ABAABBBA_a_tail_issue > t_ABAABBBA_a_tail_dep) ? t_ABAABBBA_a_tail_issue : t_ABAABBBA_a_tail_dep;
...
wire [8:0] t_ABABAABB_a_tail_issue = t_ABABAABB_b4_rb + A_tail_after_3;
wire [8:0] t_ABABAABB_a_tail_dep = t_ABABAABB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABABAABB_cycle = (t_ABABAABB_a_tail_issue > t_ABABAABB_a_tail_dep) ? t_ABABAABB_a_tail_issue : t_ABABAABB_a_tail_dep;
...
wire [8:0] t_ABABABAB_a_tail_issue = t_ABABABAB_b4_rb + A_tail_after_3;
wire [8:0] t_ABABABAB_a_tail_dep = t_ABABABAB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABABABAB_cycle = (t_ABABABAB_a_tail_issue > t_ABABABAB_a_tail_dep) ? t_ABABABAB_a_tail_issue : t_ABABABAB_a_tail_dep;
...
wire [8:0] t_ABABABBA_a_tail_issue = t_ABABABBA_b4_rb + A_tail_after_3;
wire [8:0] t_ABABABBA_a_tail_dep = t_ABABABBA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABABABBA_cycle = (t_ABABABBA_a_tail_issue > t_ABABABBA_a_tail_dep) ? t_ABABABBA_a_tail_issue : t_ABABABBA_a_tail_dep;
...
wire [8:0] t_ABABBAAB_a_tail_issue = t_ABABBAAB_b4_rb + A_tail_after_3;
wire [8:0] t_ABABBAAB_a_tail_dep = t_ABABBAAB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABABBAAB_cycle = (t_ABABBAAB_a_tail_issue > t_ABABBAAB_a_tail_dep) ? t_ABABBAAB_a_tail_issue : t_ABABBAAB_a_tail_dep;
...
wire [8:0] t_ABABBABA_a_tail_issue = t_ABABBABA_b4_rb + A_tail_after_3;
wire [8:0] t_ABABBABA_a_tail_dep = t_ABABBABA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABABBABA_cycle = (t_ABABBABA_a_tail_issue > t_ABABBABA_a_tail_dep) ? t_ABABBABA_a_tail_issue : t_ABABBABA_a_tail_dep;
...
wire [8:0] t_ABABBBAA_a_tail_issue = t_ABABBBAA_b4_rb + A_tail_after_3;
wire [8:0] t_ABABBBAA_a_tail_dep = t_ABABBBAA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABABBBAA_cycle = (t_ABABBBAA_a_tail_issue > t_ABABBBAA_a_tail_dep) ? t_ABABBBAA_a_tail_issue : t_ABABBBAA_a_tail_dep;

// l44_ABBAAABB_cycle
wire [7:0] t_ABBAAABB_b4_path = bw_BAAABB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBAAABB_a_tail_issue = t_ABBAAABB_b4_rb + A_tail_after_3;
wire [8:0] t_ABBAAABB_a_tail_dep = t_ABBAAABB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBAAABB_cycle = (t_ABBAAABB_a_tail_issue > t_ABBAAABB_a_tail_dep) ? t_ABBAAABB_a_tail_issue : t_ABBAAABB_a_tail_dep;

// l44_ABBAABAB_cycle
wire [7:0] t_ABBAABAB_b4_path = bw_BAABAB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBAABAB_a_tail_issue = t_ABBAABAB_b4_rb + A_tail_after_3;
wire [8:0] t_ABBAABAB_a_tail_dep = t_ABBAABAB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBAABAB_cycle = (t_ABBAABAB_a_tail_issue > t_ABBAABAB_a_tail_dep) ? t_ABBAABAB_a_tail_issue : t_ABBAABAB_a_tail_dep;

// l44_ABBAABBA_cycle
wire [7:0] t_ABBAABBA_b4_path = bw_BAABBA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBAABBA_a_tail_issue = t_ABBAABBA_b4_rb + A_tail_after_3;
wire [8:0] t_ABBAABBA_a_tail_dep = t_ABBAABBA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBAABBA_cycle = (t_ABBAABBA_a_tail_issue > t_ABBAABBA_a_tail_dep) ? t_ABBAABBA_a_tail_issue : t_ABBAABBA_a_tail_dep;

// l44_ABBABAAB_cycle
wire [7:0] t_ABBABAAB_b4_path = bw_BABAAB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBABAAB_a_tail_issue = t_ABBABAAB_b4_rb + A_tail_after_3;
wire [8:0] t_ABBABAAB_a_tail_dep = t_ABBABAAB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBABAAB_cycle = (t_ABBABAAB_a_tail_issue > t_ABBABAAB_a_tail_dep) ? t_ABBABAAB_a_tail_issue : t_ABBABAAB_a_tail_dep;

// l44_ABBABABA_cycle
wire [7:0] t_ABBABABA_b4_path = bw_BABABA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBABABA_a_tail_issue = t_ABBABABA_b4_rb + A_tail_after_3;
wire [8:0] t_ABBABABA_a_tail_dep = t_ABBABABA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBABABA_cycle = (t_ABBABABA_a_tail_issue > t_ABBABABA_a_tail_dep) ? t_ABBABABA_a_tail_issue : t_ABBABABA_a_tail_dep;

// l44_ABBABBAA_cycle
wire [7:0] t_ABBABBAA_b4_path = bw_BABBAA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBABBAA_a_tail_issue = t_ABBABBAA_b4_rb + A_tail_after_3;
wire [8:0] t_ABBABBAA_a_tail_dep = t_ABBABBAA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBABBAA_cycle = (t_ABBABBAA_a_tail_issue > t_ABBABBAA_a_tail_dep) ? t_ABBABBAA_a_tail_issue : t_ABBABBAA_a_tail_dep;

// l44_ABBBAAAB_cycle
wire [7:0] t_ABBBAAAB_b4_path = bw_BBAAAB_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBBAAAB_a_tail_issue = t_ABBBAAAB_b4_rb + A_tail_after_3;
wire [8:0] t_ABBBAAAB_a_tail_dep = t_ABBBAAAB_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBBAAAB_cycle = (t_ABBBAAAB_a_tail_issue > t_ABBBAAAB_a_tail_dep) ? t_ABBBAAAB_a_tail_issue : t_ABBBAAAB_a_tail_dep;

// l44_ABBBAABA_cycle
wire [7:0] t_ABBBAABA_b4_path = bw_BBAABA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBBAABA_a_tail_issue = t_ABBBAABA_b4_rb + A_tail_after_3;
wire [8:0] t_ABBBAABA_a_tail_dep = t_ABBBAABA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBBAABA_cycle = (t_ABBBAABA_a_tail_issue > t_ABBBAABA_a_tail_dep) ? t_ABBBAABA_a_tail_issue : t_ABBBAABA_a_tail_dep;

// l44_ABBBABAA_cycle
wire [7:0] t_ABBBABAA_b4_path = bw_BBABAA_rb + {{2{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBBABAA_a_tail_issue = t_ABBBABAA_b4_rb + A_tail_after_3;
wire [8:0] t_ABBBABAA_a_tail_dep = t_ABBBABAA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBBABAA_cycle = (t_ABBBABAA_a_tail_issue > t_ABBBABAA_a_tail_dep) ? t_ABBBABAA_a_tail_issue : t_ABBBABAA_a_tail_dep;

// l44_ABBBBAAA_cycle
wire [8:0] t_ABBBBAAA_b4_path = {{1{1'b0}}, bw_BBBAAA_rb} + {{3{1'b0}}, B_bw_step_3};
...
wire [8:0] t_ABBBBAAA_a_tail_issue = t_ABBBBAAA_b4_rb + A_tail_after_3;
wire [8:0] t_ABBBBAAA_a_tail_dep = t_ABBBBAAA_b4_ra + A_tail_sum_3;
wire [8:0] l44_ABBBBAAA_cycle = (t_ABBBBAAA_a_tail_issue > t_ABBBBAAA_a_tail_dep) ? t_ABBBBAAA_a_tail_issue : t_ABBBBAAA_a_tail_dep;

//////// FINAL LEAVES ////////

// l80_AAAAAAAA_cycle
wire [8:0] f_AAAAAAAA_path = bw_AAAAAAA_ra + {{3{1'b0}}, A_bw_step_7};
...
// l71_AAAAAAAB_cycle
wire [8:0] f_AAAAAAAB_path = bw_AAAAAAB_ra + {{3{1'b0}}, A_bw_step_6};
...
// l71_AAAAAABA_cycle
wire [8:0] f_AAAAAABA_path = bw_AAAAABA_ra + {{3{1'b0}}, A_bw_step_6};
...
// l62_AAAAAABB_cycle
wire [8:0] f_AAAAAABB_path = bw_AAAAABB_ra + {{3{1'b0}}, A_bw_step_5};
...
// l71_AAAAABAA_cycle
wire [8:0] f_AAAAABAA_path = bw_AAAABAA_ra + {{3{1'b0}}, A_bw_step_6};
...
// l62_AAAAABAB_cycle
wire [8:0] f_AAAAABAB_path = {{1{1'b0}}, bw_AAAABAB_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l62_AAAAABBA_cycle
wire [8:0] f_AAAAABBA_path = {{1{1'b0}}, bw_AAAABBA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AAAAABBB_cycle
wire [8:0] f_AAAAABBB_path = bw_AAAABBB_ra + {{3{1'b0}}, A_bw_step_4};
...
// l71_AAAABAAA_cycle
wire [8:0] f_AAAABAAA_path = bw_AAABAAA_ra + {{3{1'b0}}, A_bw_step_6};
...
// l62_AAAABAAB_cycle
wire [8:0] f_AAAABAAB_path = {{1{1'b0}}, bw_AAABAAB_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l62_AAAABABA_cycle
wire [8:0] f_AAAABABA_path = {{1{1'b0}}, bw_AAABABA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AAAABABB_cycle
wire [8:0] f_AAAABABB_path = {{1{1'b0}}, bw_AAABABB_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l62_AAAABBAA_cycle
wire [8:0] f_AAAABBAA_path = {{1{1'b0}}, bw_AAABBAA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AAAABBAB_cycle
wire [8:0] f_AAAABBAB_path = {{1{1'b0}}, bw_AAABBAB_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l53_AAAABBBA_cycle
wire [8:0] f_AAAABBBA_path = {{1{1'b0}}, bw_AAABBBA_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l71_AAABAAAA_cycle
wire [8:0] f_AAABAAAA_path = bw_AABAAAA_ra + {{3{1'b0}}, A_bw_step_6};
...
// l62_AAABAAAB_cycle
wire [8:0] f_AAABAAAB_path = {{1{1'b0}}, bw_AABAAAB_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l62_AAABAABA_cycle
wire [8:0] f_AAABAABA_path = {{1{1'b0}}, bw_AABAABA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AAABAABB_cycle
wire [8:0] f_AAABAABB_path = {{1{1'b0}}, bw_AABAABB_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l62_AAABABAA_cycle
wire [8:0] f_AAABABAA_path = {{1{1'b0}}, bw_AABABAA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AAABABAB_cycle
wire [7:0] f_AAABABAB_path = bw_AABABAB_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AAABABBA_cycle
wire [7:0] f_AAABABBA_path = bw_AABABBA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l62_AAABBAAA_cycle
wire [8:0] f_AAABBAAA_path = {{1{1'b0}}, bw_AABBAAA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AAABBAAB_cycle
wire [7:0] f_AAABBAAB_path = bw_AABBAAB_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AAABBABA_cycle
wire [7:0] f_AAABBABA_path = bw_AABBABA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AAABBBAA_cycle
wire [8:0] f_AAABBBAA_path = {{1{1'b0}}, bw_AABBBAA_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l71_AABAAAAA_cycle
wire [8:0] f_AABAAAAA_path = bw_ABAAAAA_ra + {{3{1'b0}}, A_bw_step_6};
...
// l62_AABAAAAB_cycle
wire [8:0] f_AABAAAAB_path = {{1{1'b0}}, bw_ABAAAAB_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l62_AABAAABA_cycle
wire [8:0] f_AABAAABA_path = {{1{1'b0}}, bw_ABAAABA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AABAAABB_cycle
wire [8:0] f_AABAAABB_path = {{1{1'b0}}, bw_ABAAABB_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l62_AABAABAA_cycle
wire [8:0] f_AABAABAA_path = {{1{1'b0}}, bw_ABAABAA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AABAABAB_cycle
wire [7:0] f_AABAABAB_path = bw_ABAABAB_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AABAABBA_cycle
wire [7:0] f_AABAABBA_path = bw_ABAABBA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l62_AABABAAA_cycle
wire [8:0] f_AABABAAA_path = {{1{1'b0}}, bw_ABABAAA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AABABAAB_cycle
wire [7:0] f_AABABAAB_path = bw_ABABAAB_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AABABABA_cycle
wire [7:0] f_AABABABA_path = bw_ABABABA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AABABBAA_cycle
wire [7:0] f_AABABBAA_path = bw_ABABBAA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l62_AABBAAAA_cycle
wire [8:0] f_AABBAAAA_path = {{1{1'b0}}, bw_ABBAAAA_ra} + {{3{1'b0}}, A_bw_step_5};
...
// l53_AABBAAAB_cycle
wire [7:0] f_AABBAAAB_path = bw_ABBAAAB_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AABBAABA_cycle
wire [7:0] f_AABBAABA_path = bw_ABBAABA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AABBABAA_cycle
wire [7:0] f_AABBABAA_path = bw_ABBABAA_ra + {{2{1'b0}}, A_bw_step_4};
...
// l53_AABBBAAA_cycle
wire [8:0] f_AABBBAAA_path = {{1{1'b0}}, bw_ABBBAAA_ra} + {{3{1'b0}}, A_bw_step_4};
...
// l62_BBAAAAAA_cycle
wire [8:0] f_BBAAAAAA_path = bw_BAAAAAA_rb + {{3{1'b0}}, B_bw_step_1};
...
// l53_BBAAAAAB_cycle
wire [8:0] f_BBAAAAAB_path = {{1{1'b0}}, bw_BAAAAAB_rb} + {{3{1'b0}}, B_bw_step_2};
...
// l53_BBAAAABA_cycle
wire [8:0] f_BBAAAABA_path = {{1{1'b0}}, bw_BAAAABA_rb} + {{3{1'b0}}, B_bw_step_2};
...
// l44_BBAAAABB_cycle
wire [8:0] f_BBAAAABB_path = {{1{1'b0}}, bw_BAAAABB_rb} + {{3{1'b0}}, B_bw_step_3};
...
// l53_BBAAABAA_cycle
wire [8:0] f_BBAAABAA_path = {{1{1'b0}}, bw_BAAABAA_rb} + {{3{1'b0}}, B_bw_step_2};
...
// l44_BBAAABAB_cycle
wire [7:0] f_BBAAABAB_path = bw_BAAABAB_rb + {{2{1'b0}}, B_bw_step_3};
...
// l44_BBAAABBA_cycle
wire [7:0] f_BBAAABBA_path = bw_BAAABBA_rb + {{2{1'b0}}, B_bw_step_3};
...
// l53_BBAABAAA_cycle
wire [8:0] f_BBAABAAA_path = {{1{1'b0}}, bw_BAABAAA_rb} + {{3{1'b0}}, B_bw_step_2};
...
// l44_BBAABAAB_cycle
wire [7:0] f_BBAABAAB_path = bw_BAABAAB_rb + {{2{1'b0}}, B_bw_step_3};
...
// l44_BBAABABA_cycle
wire [7:0] f_BBAABABA_path = bw_BAABABA_rb + {{2{1'b0}}, B_bw_step_3};
...
// l44_BBAABBAA_cycle
wire [7:0] f_BBAABBAA_path = bw_BAABBAA_rb + {{2{1'b0}}, B_bw_step_3};
...
// l53_BBABAAAA_cycle
wire [8:0] f_BBABAAAA_path = {{1{1'b0}}, bw_BABAAAA_rb} + {{3{1'b0}}, B_bw_step_2};
...
// l44_BBABAAAB_cycle
wire [7:0] f_BBABAAAB_path = bw_BABAAAB_rb + {{2{1'b0}}, B_bw_step_3};
...
// l44_BBABAABA_cycle
wire [7:0] f_BBABAABA_path = bw_BABAABA_rb + {{2{1'b0}}, B_bw_step_3};
...
// l44_BBABABAA_cycle
wire [7:0] f_BBABABAA_path = bw_BABABAA_rb + {{2{1'b0}}, B_bw_step_3};
...
// l44_BBABBAAA_cycle
wire [8:0] f_BBABBAAA_path = {{1{1'b0}}, bw_BABBAAA_rb} + {{3{1'b0}}, B_bw_step_3};
...
// l53_BBBAAAAA_cycle
wire [8:0] f_BBBAAAAA_path = bw_BBAAAAA_rb + {{3{1'b0}}, B_bw_step_2};
...
// l44_BBBAAAAB_cycle
wire [8:0] f_BBBAAAAB_path = {{1{1'b0}}, bw_BBAAAAB_rb} + {{3{1'b0}}, B_bw_step_3};
...
// l44_BBBAAABA_cycle
wire [8:0] f_BBBAAABA_path = {{1{1'b0}}, bw_BBAAABA_rb} + {{3{1'b0}}, B_bw_step_3};
...
// l44_BBBAABAA_cycle
wire [8:0] f_BBBAABAA_path = {{1{1'b0}}, bw_BBAABAA_rb} + {{3{1'b0}}, B_bw_step_3};
...
// l44_BBBABAAA_cycle
wire [8:0] f_BBBABAAA_path = {{1{1'b0}}, bw_BBABAAA_rb} + {{3{1'b0}}, B_bw_step_3};
...
// l44_BBBBAAAA_cycle
wire [8:0] f_BBBBAAAA_path = bw_BBBAAAA_rb + {{3{1'b0}}, B_bw_step_3};
