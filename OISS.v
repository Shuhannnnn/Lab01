// Self-contained OISS refined hybrid scheduler. No external include files required.
...
// Arithmetic widths follow per-node bounds at latency <= 50.
// Narrow merged values are meaningful only when the corresponding slot is valid.
// Local selectors carry static B_len eligibility; 511 is introduced at tree outputs.
...
wire [5:0] d4_AB_dep = 1'b0 + A_rev_lat[0];
wire [5:0] d4_AB_issue = B_rev_lat[0] + 6'd1;
wire [5:0] d4_AB_head = (d4_AB_dep >= d4_AB_issue) ? d4_AB_dep : d4_AB_issue;
wire [5:0] d4_BA_dep = 1'b0 + B_rev_lat[0];
wire [5:0] d4_BA_issue = A_rev_lat[0] + 6'd1;
wire [5:0] d4_BA_head = (d4_BA_dep >= d4_BA_issue) ? d4_BA_dep : d4_BA_issue;
wire [6:0] d4_BB_sum = B_rev_lat[0] + B_rev_lat[1];

// Fixed suffix depth 3.
wire [7:0] d4_AAA_sum = d4_AA_sum + A_rev_lat[2];
wire [6:0] d4_AAB_sum = d4_AB_head + A_rev_lat[1];
wire [6:0] d4_ABA_dep = A_rev_lat[0] + A_rev_lat[1];
wire [5:0] d4_ABA_issue = d4_BA_head + 6'd1;
wire [6:0] d4_ABA_head = (d4_ABA_dep >= d4_ABA_issue) ? d4_ABA_dep : d4_ABA_issue;
wire [5:0] d4_ABB_dep = 1'b0 + A_rev_lat[0];
wire [6:0] d4_ABB_issue = d4_BB_sum + 7'd1;
wire [6:0] d4_ABB_head = (d4_ABB_dep >= d4_ABB_issue) ? d4_ABB_dep : d4_ABB_issue;
wire [5:0] d4_BAA_dep = 1'b0 + B_rev_lat[0];
wire [6:0] d4_BAA_issue = d4_AA_sum + 7'd1;
wire [6:0] d4_BAA_head = (d4_BAA_dep >= d4_BAA_issue) ? d4_BAA_dep : d4_BAA_issue;
wire [6:0] d4_BAB_dep = B_rev_lat[0] + B_rev_lat[1];
wire [5:0] d4_BAB_issue = d4_AB_head + 6'd1;
wire [6:0] d4_BAB_head = (d4_BAB_dep >= d4_BAB_issue) ? d4_BAB_dep : d4_BAB_issue;
wire [6:0] d4_BBA_sum = d4_BA_head + B_rev_lat[1];
...
wire [6:0] d4_ABAB_dep = d4_AB_head + A_rev_lat[1];
wire [6:0] d4_ABAB_issue = d4_BAB_head + 7'd1;
wire [6:0] d4_ABAB_head = (d4_ABAB_dep >= d4_ABAB_issue) ? d4_ABAB_dep : d4_ABAB_issue;
wire [6:0] d4_ABBA_dep = A_rev_lat[0] + A_rev_lat[1];
wire [6:0] d4_ABBA_issue = d4_BBA_sum + 7'd1;
wire [6:0] d4_ABBA_head = (d4_ABBA_dep >= d4_ABBA_issue) ? d4_ABBA_dep : d4_ABBA_issue;
wire [5:0] d4_ABBB_dep = 1'b0 + A_rev_lat[0];
wire [7:0] d4_ABBB_issue = d4_BBB_sum + 8'd1;
wire [7:0] d4_ABBB_head = (d4_ABBB_dep >= d4_ABBB_issue) ? d4_ABBB_dep : d4_ABBB_issue;
wire [5:0] d4_BAAA_dep = 1'b0 + B_rev_lat[0];
wire [7:0] d4_BAAA_issue = d4_AAA_sum + 8'd1;
wire [7:0] d4_BAAA_head = (d4_BAAA_dep >= d4_BAAA_issue) ? d4_BAAA_dep : d4_BAAA_issue;
wire [6:0] d4_BAAB_dep = B_rev_lat[0] + B_rev_lat[1];
wire [6:0] d4_BAAB_issue = d4_AAB_sum + 7'd1;
wire [6:0] d4_BAAB_head = (d4_BAAB_dep >= d4_BAAB_issue) ? d4_BAAB_dep : d4_BAAB_issue;
wire [6:0] d4_BABA_dep = d4_BA_head + B_rev_lat[1];
wire [6:0] d4_BABA_issue = d4_ABA_head + 7'd1;
wire [6:0] d4_BABA_head = (d4_BABA_dep >= d4_BABA_issue) ? d4_BABA_dep : d4_BABA_issue;
...
wire [5:0] d4_sa_1 = d4_sa_0 + A_rev_lat[0];
wire [6:0] d4_sa_2 = d4_sa_1 + A_rev_lat[1];
wire [7:0] d4_sa_3 = d4_sa_2 + A_rev_lat[2];
wire [7:0] d4_sa_4 = d4_sa_3 + A_rev_lat[3];
wire [0:0] d4_sb_0 = 1'b0;
wire [5:0] d4_sb_1 = d4_sb_0 + B_rev_lat[0];
wire [6:0] d4_sb_2 = d4_sb_1 + B_rev_lat[1];
...
wire [5:0] m4_1a3b_eb0_bound = d4_sa_1 + 6'd3;
...
wire [5:0] m4_1a3b_eb0_other = d4_sa_1 + m4_1a3b_eb0_m1_0_value;
...
wire [5:0] m4_1a3b_eb1_bound = d4_sa_1 + 6'd3;
...
wire [5:0] m4_1a3b_eb1_other = d4_sa_1 + m4_1a3b_eb1_m1_0_value;
...
wire [6:0] m4_2a2b_ea0_fixed = d4_sa_2 + 7'd0;
wire [6:0] m4_2a2b_ea0_axis_bound = d4_sa_2 + 7'd2;
wire [6:0] m4_2a2b_ea0_bound = d4_sb_2 + 7'd2;
...
wire [6:0] m4_2a2b_ea0_other = d4_sb_2 + m4_2a2b_ea0_m2_0_value;
...
wire [6:0] m4_2a2b_ea1_fixed = d4_sa_2 + 7'd1;
wire [6:0] m4_2a2b_ea1_axis_bound = d4_sa_2 + 7'd2;
wire [6:0] m4_2a2b_ea1_bound = d4_sb_2 + 7'd2;
...
wire [6:0] m4_2a2b_ea1_other = d4_sb_2 + m4_2a2b_ea1_m2_0_value;
...
wire [6:0] m4_2a2b_ea2_fixed = d4_sa_2 + 7'd2;
wire [6:0] m4_2a2b_ea2_axis_bound = d4_sa_2 + 7'd2;
wire [6:0] m4_2a2b_ea2_bound = d4_sb_2 + 7'd2;
...
wire [6:0] m4_2a2b_ea2_other = d4_sb_2 + m4_2a2b_ea2_m2_0_value;
...
wire [5:0] m4_3a1b_ea0_bound = d4_sb_1 + 6'd3;
...
wire [5:0] m4_3a1b_ea0_other = d4_sb_1 + m4_3a1b_ea0_m1_0_value;
...
wire [5:0] m4_3a1b_ea1_bound = d4_sb_1 + 6'd3;
...
wire [5:0] m4_3a1b_ea1_other = d4_sb_1 + m4_3a1b_ea1_m1_0_value;
...
wire [5:0] t_0a4b_eb0_A_dep = m4_0a4b_eb0_ra + A_rev_lat[0];
...
wire [7:0] t_0a4b_eb0_AA_dep = t_0a4b_eb0_A_head + A_rev_lat[1];
...
wire [6:0] t_1a3b_eb0_A_dep = m4_1a3b_eb0_ra + A_rev_lat[1];
...
wire [7:0] t_1a3b_eb0_AA_dep = t_1a3b_eb0_A_head + A_rev_lat[2];
wire [6:0] t_1a3b_eb0_AB_dep = m4_1a3b_eb0_ra + A_rev_lat[1];
wire [7:0] t_1a3b_eb0_AB_issue = t_1a3b_eb0_B_head + 8'd1;
wire [7:0] t_1a3b_eb0_AB_head = (t_1a3b_eb0_AB_dep >= t_1a3b_eb0_AB_issue) ? t_1a3b_eb0_AB_dep : t_1a3b_eb0_AB_issue;
wire [7:0] t_1a3b_eb0_BA_dep = m4_1a3b_eb0_rb + B_rev_lat[3];
wire [7:0] t_1a3b_eb0_BA_issue = t_1a3b_eb0_A_head + 8'd1;
wire [7:0] t_1a3b_eb0_BA_head = (t_1a3b_eb0_BA_dep >= t_1a3b_eb0_BA_issue) ? t_1a3b_eb0_BA_dep : t_1a3b_eb0_BA_issue;
wire [7:0] t_1a3b_eb0_AAA_dep = t_1a3b_eb0_AA_dep + A_rev_lat[3];
wire [7:0] t_1a3b_eb0_AAB_dep = t_1a3b_eb0_AB_head + A_rev_lat[2];
wire [7:0] t_1a3b_eb0_ABA_dep = t_1a3b_eb0_A_head + A_rev_lat[2];
wire [7:0] t_1a3b_eb0_ABA_issue = t_1a3b_eb0_BA_head + 8'd1;
wire [7:0] t_1a3b_eb0_ABA_head = (t_1a3b_eb0_ABA_dep >= t_1a3b_eb0_ABA_issue) ? t_1a3b_eb0_ABA_dep : t_1a3b_eb0_ABA_issue;
wire [7:0] t_1a3b_eb0_BAA_dep = m4_1a3b_eb0_rb + B_rev_lat[3];
wire [7:0] t_1a3b_eb0_BAA_issue = t_1a3b_eb0_AA_dep + 8'd1;
wire [7:0] t_1a3b_eb0_BAA_head = (t_1a3b_eb0_BAA_dep >= t_1a3b_eb0_BAA_issue) ? t_1a3b_eb0_BAA_dep : t_1a3b_eb0_BAA_issue;
wire [8:0] t_1a3b_eb0_AAAA_dep = t_1a3b_eb0_AAA_dep + A_rev_lat[4];
wire [8:0] t_1a3b_eb0_AAAB_dep = t_1a3b_eb0_AAB_dep + A_rev_lat[3];
wire [7:0] t_1a3b_eb0_AABA_dep = t_1a3b_eb0_ABA_head + A_rev_lat[3];
wire [7:0] t_1a3b_eb0_ABAA_dep = t_1a3b_eb0_AA_dep + A_rev_lat[3];
wire [7:0] t_1a3b_eb0_ABAA_issue = t_1a3b_eb0_BAA_head + 8'd1;
wire [7:0] t_1a3b_eb0_ABAA_head = (t_1a3b_eb0_ABAA_dep >= t_1a3b_eb0_ABAA_issue) ? t_1a3b_eb0_ABAA_dep : t_1a3b_eb0_ABAA_issue;
wire [7:0] t_1a3b_eb0_BAAA_dep = m4_1a3b_eb0_rb + B_rev_lat[3];
wire [7:0] t_1a3b_eb0_BAAA_issue = t_1a3b_eb0_AAA_dep + 8'd1;
wire [7:0] t_1a3b_eb0_BAAA_head = (t_1a3b_eb0_BAAA_dep >= t_1a3b_eb0_BAAA_issue) ? t_1a3b_eb0_BAAA_dep : t_1a3b_eb0_BAAA_issue;
wire m4_1a3b_eb0_tail_m0_0_pick = (B_len == 3'd3);
wire [8:0] m4_1a3b_eb0_tail_m0_0_value = m4_1a3b_eb0_tail_m0_0_pick ? t_1a3b_eb0_AAAA_dep : t_1a3b_eb0_AAAB_dep;
wire [3:0] m4_1a3b_eb0_tail_m0_0_path = m4_1a3b_eb0_tail_m0_0_pick ? 4'b1111 : 4'b1110;
wire m4_1a3b_eb0_tail_m0_1_pick = (t_1a3b_eb0_AABA_dep <= t_1a3b_eb0_ABAA_head);
wire [7:0] m4_1a3b_eb0_tail_m0_1_value = m4_1a3b_eb0_tail_m0_1_pick ? t_1a3b_eb0_AABA_dep : t_1a3b_eb0_ABAA_head;
wire [3:0] m4_1a3b_eb0_tail_m0_1_path = m4_1a3b_eb0_tail_m0_1_pick ? 4'b1101 : 4'b1011;
wire m4_1a3b_eb0_tail_m1_0_pick = (!(B_len == 3'd4) || (m4_1a3b_eb0_tail_m0_0_value <= m4_1a3b_eb0_tail_m0_1_value));
...
wire m4_1a3b_eb0_tail_m2_0_pick = (!(B_len == 3'd4) || (m4_1a3b_eb0_tail_m1_0_value <= t_1a3b_eb0_BAAA_head));
wire [8:0] m4_1a3b_eb0_tail_m2_0_value = m4_1a3b_eb0_tail_m2_0_pick ? m4_1a3b_eb0_tail_m1_0_value : t_1a3b_eb0_BAAA_head;
wire [3:0] m4_1a3b_eb0_tail_m2_0_path = m4_1a3b_eb0_tail_m2_0_pick ? m4_1a3b_eb0_tail_m1_0_path : 4'b0111;
wire [8:0] m4_1a3b_eb0_cycle = m4_1a3b_eb0_v && (B_len == 3'd3 || B_len == 3'd4) ? m4_1a3b_eb0_tail_m2_0_value : 9'd511;
...
wire [6:0] t_1a3b_eb1_A_dep = m4_1a3b_eb1_ra + A_rev_lat[1];
...
wire [7:0] t_1a3b_eb1_AA_dep = t_1a3b_eb1_A_head + A_rev_lat[2];
wire [6:0] t_1a3b_eb1_AB_dep = m4_1a3b_eb1_ra + A_rev_lat[1];
wire [7:0] t_1a3b_eb1_AB_issue = t_1a3b_eb1_B_head + 8'd1;
wire [7:0] t_1a3b_eb1_AB_head = (t_1a3b_eb1_AB_dep >= t_1a3b_eb1_AB_issue) ? t_1a3b_eb1_AB_dep : t_1a3b_eb1_AB_issue;
wire [7:0] t_1a3b_eb1_BA_dep = m4_1a3b_eb1_rb + B_rev_lat[3];
wire [7:0] t_1a3b_eb1_BA_issue = t_1a3b_eb1_A_head + 8'd1;
wire [7:0] t_1a3b_eb1_BA_head = (t_1a3b_eb1_BA_dep >= t_1a3b_eb1_BA_issue) ? t_1a3b_eb1_BA_dep : t_1a3b_eb1_BA_issue;
wire [7:0] t_1a3b_eb1_AAA_dep = t_1a3b_eb1_AA_dep + A_rev_lat[3];
wire [7:0] t_1a3b_eb1_AAB_dep = t_1a3b_eb1_AB_head + A_rev_lat[2];
wire [7:0] t_1a3b_eb1_ABA_dep = t_1a3b_eb1_A_head + A_rev_lat[2];
wire [7:0] t_1a3b_eb1_ABA_issue = t_1a3b_eb1_BA_head + 8'd1;
wire [7:0] t_1a3b_eb1_ABA_head = (t_1a3b_eb1_ABA_dep >= t_1a3b_eb1_ABA_issue) ? t_1a3b_eb1_ABA_dep : t_1a3b_eb1_ABA_issue;
wire [7:0] t_1a3b_eb1_BAA_dep = m4_1a3b_eb1_rb + B_rev_lat[3];
wire [7:0] t_1a3b_eb1_BAA_issue = t_1a3b_eb1_AA_dep + 8'd1;
wire [7:0] t_1a3b_eb1_BAA_head = (t_1a3b_eb1_BAA_dep >= t_1a3b_eb1_BAA_issue) ? t_1a3b_eb1_BAA_dep : t_1a3b_eb1_BAA_issue;
wire [8:0] t_1a3b_eb1_AAAA_dep = t_1a3b_eb1_AAA_dep + A_rev_lat[4];
wire [8:0] t_1a3b_eb1_AAAB_dep = t_1a3b_eb1_AAB_dep + A_rev_lat[3];
wire [7:0] t_1a3b_eb1_AABA_dep = t_1a3b_eb1_ABA_head + A_rev_lat[3];
wire [7:0] t_1a3b_eb1_ABAA_dep = t_1a3b_eb1_AA_dep + A_rev_lat[3];
wire [7:0] t_1a3b_eb1_ABAA_issue = t_1a3b_eb1_BAA_head + 8'd1;
wire [7:0] t_1a3b_eb1_ABAA_head = (t_1a3b_eb1_ABAA_dep >= t_1a3b_eb1_ABAA_issue) ? t_1a3b_eb1_ABAA_dep : t_1a3b_eb1_ABAA_issue;
wire [7:0] t_1a3b_eb1_BAAA_dep = m4_1a3b_eb1_rb + B_rev_lat[3];
wire [7:0] t_1a3b_eb1_BAAA_issue = t_1a3b_eb1_AAA_dep + 8'd1;
wire [7:0] t_1a3b_eb1_BAAA_head = (t_1a3b_eb1_BAAA_dep >= t_1a3b_eb1_BAAA_issue) ? t_1a3b_eb1_BAAA_dep : t_1a3b_eb1_BAAA_issue;
wire m4_1a3b_eb1_tail_m0_0_pick = (B_len == 3'd3);
wire [8:0] m4_1a3b_eb1_tail_m0_0_value = m4_1a3b_eb1_tail_m0_0_pick ? t_1a3b_eb1_AAAA_dep : t_1a3b_eb1_AAAB_dep;
wire [3:0] m4_1a3b_eb1_tail_m0_0_path = m4_1a3b_eb1_tail_m0_0_pick ? 4'b1111 : 4'b1110;
wire m4_1a3b_eb1_tail_m0_1_pick = (t_1a3b_eb1_AABA_dep <= t_1a3b_eb1_ABAA_head);
wire [7:0] m4_1a3b_eb1_tail_m0_1_value = m4_1a3b_eb1_tail_m0_1_pick ? t_1a3b_eb1_AABA_dep : t_1a3b_eb1_ABAA_head;
wire [3:0] m4_1a3b_eb1_tail_m0_1_path = m4_1a3b_eb1_tail_m0_1_pick ? 4'b1101 : 4'b1011;
wire m4_1a3b_eb1_tail_m1_0_pick = (!(B_len == 3'd4) || (m4_1a3b_eb1_tail_m0_0_value <= m4_1a3b_eb1_tail_m0_1_value));
...
wire m4_1a3b_eb1_tail_m2_0_pick = (!(B_len == 3'd4) || (m4_1a3b_eb1_tail_m1_0_value <= t_1a3b_eb1_BAAA_head));
wire [8:0] m4_1a3b_eb1_tail_m2_0_value = m4_1a3b_eb1_tail_m2_0_pick ? m4_1a3b_eb1_tail_m1_0_value : t_1a3b_eb1_BAAA_head;
wire [3:0] m4_1a3b_eb1_tail_m2_0_path = m4_1a3b_eb1_tail_m2_0_pick ? m4_1a3b_eb1_tail_m1_0_path : 4'b0111;
wire [8:0] m4_1a3b_eb1_cycle = m4_1a3b_eb1_v && (B_len == 3'd3 || B_len == 3'd4) ? m4_1a3b_eb1_tail_m2_0_value : 9'd511;
...
wire [7:0] t_2a2b_ea0_AA_dep = t_2a2b_ea0_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea0_AB_dep = m4_2a2b_ea0_ra + A_rev_lat[2];
wire [7:0] t_2a2b_ea0_AB_issue = t_2a2b_ea0_B_head + 8'd1;
wire [7:0] t_2a2b_ea0_AB_head = (t_2a2b_ea0_AB_dep >= t_2a2b_ea0_AB_issue) ? t_2a2b_ea0_AB_dep : t_2a2b_ea0_AB_issue;
wire [7:0] t_2a2b_ea0_BA_dep = m4_2a2b_ea0_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea0_BA_issue = t_2a2b_ea0_A_head + 8'd1;
wire [7:0] t_2a2b_ea0_BA_head = (t_2a2b_ea0_BA_dep >= t_2a2b_ea0_BA_issue) ? t_2a2b_ea0_BA_dep : t_2a2b_ea0_BA_issue;
wire [7:0] t_2a2b_ea0_BB_dep = t_2a2b_ea0_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea0_AAA_dep = t_2a2b_ea0_AA_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea0_AAB_dep = t_2a2b_ea0_AB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea0_ABA_dep = t_2a2b_ea0_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea0_ABA_issue = t_2a2b_ea0_BA_head + 8'd1;
wire [7:0] t_2a2b_ea0_ABA_head = (t_2a2b_ea0_ABA_dep >= t_2a2b_ea0_ABA_issue) ? t_2a2b_ea0_ABA_dep : t_2a2b_ea0_ABA_issue;
wire [7:0] t_2a2b_ea0_ABB_dep = m4_2a2b_ea0_ra + A_rev_lat[2];
wire [7:0] t_2a2b_ea0_ABB_issue = t_2a2b_ea0_BB_dep + 8'd1;
wire [7:0] t_2a2b_ea0_ABB_head = (t_2a2b_ea0_ABB_dep >= t_2a2b_ea0_ABB_issue) ? t_2a2b_ea0_ABB_dep : t_2a2b_ea0_ABB_issue;
wire [7:0] t_2a2b_ea0_BAA_dep = m4_2a2b_ea0_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea0_BAA_issue = t_2a2b_ea0_AA_dep + 8'd1;
wire [7:0] t_2a2b_ea0_BAA_head = (t_2a2b_ea0_BAA_dep >= t_2a2b_ea0_BAA_issue) ? t_2a2b_ea0_BAA_dep : t_2a2b_ea0_BAA_issue;
wire [7:0] t_2a2b_ea0_BAB_dep = t_2a2b_ea0_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea0_BAB_issue = t_2a2b_ea0_AB_head + 8'd1;
wire [7:0] t_2a2b_ea0_BAB_head = (t_2a2b_ea0_BAB_dep >= t_2a2b_ea0_BAB_issue) ? t_2a2b_ea0_BAB_dep : t_2a2b_ea0_BAB_issue;
wire [7:0] t_2a2b_ea0_BBA_dep = t_2a2b_ea0_BA_head + B_rev_lat[3];
wire [8:0] t_2a2b_ea0_AAAA_dep = t_2a2b_ea0_AAA_dep + A_rev_lat[5];
wire [7:0] t_2a2b_ea0_AAAB_dep = t_2a2b_ea0_AAB_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea0_AABA_dep = t_2a2b_ea0_ABA_head + A_rev_lat[4];
wire [7:0] t_2a2b_ea0_AABB_dep = t_2a2b_ea0_ABB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea0_ABAA_dep = t_2a2b_ea0_AA_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea0_ABAA_issue = t_2a2b_ea0_BAA_head + 8'd1;
wire [7:0] t_2a2b_ea0_ABAA_head = (t_2a2b_ea0_ABAA_dep >= t_2a2b_ea0_ABAA_issue) ? t_2a2b_ea0_ABAA_dep : t_2a2b_ea0_ABAA_issue;
wire [7:0] t_2a2b_ea0_ABAB_dep = t_2a2b_ea0_AB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea0_ABAB_issue = t_2a2b_ea0_BAB_head + 8'd1;
wire [7:0] t_2a2b_ea0_ABAB_head = (t_2a2b_ea0_ABAB_dep >= t_2a2b_ea0_ABAB_issue) ? t_2a2b_ea0_ABAB_dep : t_2a2b_ea0_ABAB_issue;
wire [7:0] t_2a2b_ea0_ABBA_dep = t_2a2b_ea0_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea0_ABBA_issue = t_2a2b_ea0_BBA_dep + 8'd1;
wire [7:0] t_2a2b_ea0_ABBA_head = (t_2a2b_ea0_ABBA_dep >= t_2a2b_ea0_ABBA_issue) ? t_2a2b_ea0_ABBA_dep : t_2a2b_ea0_ABBA_issue;
wire [7:0] t_2a2b_ea0_BAAA_dep = m4_2a2b_ea0_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea0_BAAA_issue = t_2a2b_ea0_AAA_dep + 8'd1;
wire [7:0] t_2a2b_ea0_BAAA_head = (t_2a2b_ea0_BAAA_dep >= t_2a2b_ea0_BAAA_issue) ? t_2a2b_ea0_BAAA_dep : t_2a2b_ea0_BAAA_issue;
wire [7:0] t_2a2b_ea0_BAAB_dep = t_2a2b_ea0_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea0_BAAB_issue = t_2a2b_ea0_AAB_dep + 8'd1;
wire [7:0] t_2a2b_ea0_BAAB_head = (t_2a2b_ea0_BAAB_dep >= t_2a2b_ea0_BAAB_issue) ? t_2a2b_ea0_BAAB_dep : t_2a2b_ea0_BAAB_issue;
wire [7:0] t_2a2b_ea0_BABA_dep = t_2a2b_ea0_BA_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea0_BABA_issue = t_2a2b_ea0_ABA_head + 8'd1;
wire [7:0] t_2a2b_ea0_BABA_head = (t_2a2b_ea0_BABA_dep >= t_2a2b_ea0_BABA_issue) ? t_2a2b_ea0_BABA_dep : t_2a2b_ea0_BABA_issue;
wire [7:0] t_2a2b_ea0_BBAA_dep = t_2a2b_ea0_BAA_head + B_rev_lat[3];
wire m4_2a2b_ea0_tail_m0_0_pick = (B_len == 3'd2);
wire [8:0] m4_2a2b_ea0_tail_m0_0_value = m4_2a2b_ea0_tail_m0_0_pick ? t_2a2b_ea0_AAAA_dep : t_2a2b_ea0_AAAB_dep;
wire [3:0] m4_2a2b_ea0_tail_m0_0_path = m4_2a2b_ea0_tail_m0_0_pick ? 4'b1111 : 4'b1110;
wire m4_2a2b_ea0_tail_m0_1_pick = (B_len == 3'd3);
wire [7:0] m4_2a2b_ea0_tail_m0_1_value = m4_2a2b_ea0_tail_m0_1_pick ? t_2a2b_ea0_AABA_dep : t_2a2b_ea0_AABB_dep;
wire [3:0] m4_2a2b_ea0_tail_m0_1_path = m4_2a2b_ea0_tail_m0_1_pick ? 4'b1101 : 4'b1100;
wire m4_2a2b_ea0_tail_m0_2_pick = (B_len == 3'd3);
wire [7:0] m4_2a2b_ea0_tail_m0_2_value = m4_2a2b_ea0_tail_m0_2_pick ? t_2a2b_ea0_ABAA_head : t_2a2b_ea0_ABAB_head;
wire [3:0] m4_2a2b_ea0_tail_m0_2_path = m4_2a2b_ea0_tail_m0_2_pick ? 4'b1011 : 4'b1010;
wire m4_2a2b_ea0_tail_m0_3_pick = (B_len == 3'd4);
wire [7:0] m4_2a2b_ea0_tail_m0_3_value = m4_2a2b_ea0_tail_m0_3_pick ? t_2a2b_ea0_ABBA_head : t_2a2b_ea0_BAAA_head;
wire [3:0] m4_2a2b_ea0_tail_m0_3_path = m4_2a2b_ea0_tail_m0_3_pick ? 4'b1001 : 4'b0111;
wire m4_2a2b_ea0_tail_m0_4_pick = (t_2a2b_ea0_BAAB_head <= t_2a2b_ea0_BABA_head);
wire [7:0] m4_2a2b_ea0_tail_m0_4_value = m4_2a2b_ea0_tail_m0_4_pick ? t_2a2b_ea0_BAAB_head : t_2a2b_ea0_BABA_head;
wire [3:0] m4_2a2b_ea0_tail_m0_4_path = m4_2a2b_ea0_tail_m0_4_pick ? 4'b0110 : 4'b0101;
wire m4_2a2b_ea0_tail_m1_0_pick = (B_len == 3'd2 || B_len == 3'd3) && (!(B_len == 3'd3 || B_len == 3'd4) || (m4_2a2b_ea0_tail_m0_0_value <= m4_2a2b_ea0_tail_m0_1_value));
...
wire [7:0] m4_2a2b_ea0_tail_m1_1_value = m4_2a2b_ea0_tail_m1_1_pick ? m4_2a2b_ea0_tail_m0_2_value : m4_2a2b_ea0_tail_m0_3_value;
wire [3:0] m4_2a2b_ea0_tail_m1_1_path = m4_2a2b_ea0_tail_m1_1_pick ? m4_2a2b_ea0_tail_m0_2_path : m4_2a2b_ea0_tail_m0_3_path;
wire m4_2a2b_ea0_tail_m1_2_pick = (m4_2a2b_ea0_tail_m0_4_value <= t_2a2b_ea0_BBAA_dep);
wire [7:0] m4_2a2b_ea0_tail_m1_2_value = m4_2a2b_ea0_tail_m1_2_pick ? m4_2a2b_ea0_tail_m0_4_value : t_2a2b_ea0_BBAA_dep;
wire [3:0] m4_2a2b_ea0_tail_m1_2_path = m4_2a2b_ea0_tail_m1_2_pick ? m4_2a2b_ea0_tail_m0_4_path : 4'b0011;
wire m4_2a2b_ea0_tail_m2_0_pick = (!(B_len == 3'd3 || B_len == 3'd4) || (m4_2a2b_ea0_tail_m1_0_value <= m4_2a2b_ea0_tail_m1_1_value));
...
wire m4_2a2b_ea0_tail_m3_0_pick = (!(B_len == 3'd4) || (m4_2a2b_ea0_tail_m2_0_value <= m4_2a2b_ea0_tail_m1_2_value));
...
wire [8:0] m4_2a2b_ea0_cycle = m4_2a2b_ea0_v && (B_len == 3'd2 || B_len == 3'd3 || B_len == 3'd4) ? m4_2a2b_ea0_tail_m3_0_value : 9'd511;
...
wire [7:0] t_2a2b_ea1_AA_dep = t_2a2b_ea1_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea1_AB_dep = m4_2a2b_ea1_ra + A_rev_lat[2];
wire [7:0] t_2a2b_ea1_AB_issue = t_2a2b_ea1_B_head + 8'd1;
wire [7:0] t_2a2b_ea1_AB_head = (t_2a2b_ea1_AB_dep >= t_2a2b_ea1_AB_issue) ? t_2a2b_ea1_AB_dep : t_2a2b_ea1_AB_issue;
wire [7:0] t_2a2b_ea1_BA_dep = m4_2a2b_ea1_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea1_BA_issue = t_2a2b_ea1_A_head + 8'd1;
wire [7:0] t_2a2b_ea1_BA_head = (t_2a2b_ea1_BA_dep >= t_2a2b_ea1_BA_issue) ? t_2a2b_ea1_BA_dep : t_2a2b_ea1_BA_issue;
wire [7:0] t_2a2b_ea1_BB_dep = t_2a2b_ea1_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea1_AAA_dep = t_2a2b_ea1_AA_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea1_AAB_dep = t_2a2b_ea1_AB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea1_ABA_dep = t_2a2b_ea1_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea1_ABA_issue = t_2a2b_ea1_BA_head + 8'd1;
wire [7:0] t_2a2b_ea1_ABA_head = (t_2a2b_ea1_ABA_dep >= t_2a2b_ea1_ABA_issue) ? t_2a2b_ea1_ABA_dep : t_2a2b_ea1_ABA_issue;
wire [7:0] t_2a2b_ea1_ABB_dep = m4_2a2b_ea1_ra + A_rev_lat[2];
wire [7:0] t_2a2b_ea1_ABB_issue = t_2a2b_ea1_BB_dep + 8'd1;
wire [7:0] t_2a2b_ea1_ABB_head = (t_2a2b_ea1_ABB_dep >= t_2a2b_ea1_ABB_issue) ? t_2a2b_ea1_ABB_dep : t_2a2b_ea1_ABB_issue;
wire [7:0] t_2a2b_ea1_BAA_dep = m4_2a2b_ea1_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea1_BAA_issue = t_2a2b_ea1_AA_dep + 8'd1;
wire [7:0] t_2a2b_ea1_BAA_head = (t_2a2b_ea1_BAA_dep >= t_2a2b_ea1_BAA_issue) ? t_2a2b_ea1_BAA_dep : t_2a2b_ea1_BAA_issue;
wire [7:0] t_2a2b_ea1_BAB_dep = t_2a2b_ea1_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea1_BAB_issue = t_2a2b_ea1_AB_head + 8'd1;
wire [7:0] t_2a2b_ea1_BAB_head = (t_2a2b_ea1_BAB_dep >= t_2a2b_ea1_BAB_issue) ? t_2a2b_ea1_BAB_dep : t_2a2b_ea1_BAB_issue;
wire [7:0] t_2a2b_ea1_BBA_dep = t_2a2b_ea1_BA_head + B_rev_lat[3];
wire [8:0] t_2a2b_ea1_AAAA_dep = t_2a2b_ea1_AAA_dep + A_rev_lat[5];
wire [7:0] t_2a2b_ea1_AAAB_dep = t_2a2b_ea1_AAB_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea1_AABA_dep = t_2a2b_ea1_ABA_head + A_rev_lat[4];
wire [7:0] t_2a2b_ea1_AABB_dep = t_2a2b_ea1_ABB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea1_ABAA_dep = t_2a2b_ea1_AA_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea1_ABAA_issue = t_2a2b_ea1_BAA_head + 8'd1;
wire [7:0] t_2a2b_ea1_ABAA_head = (t_2a2b_ea1_ABAA_dep >= t_2a2b_ea1_ABAA_issue) ? t_2a2b_ea1_ABAA_dep : t_2a2b_ea1_ABAA_issue;
wire [7:0] t_2a2b_ea1_ABAB_dep = t_2a2b_ea1_AB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea1_ABAB_issue = t_2a2b_ea1_BAB_head + 8'd1;
wire [7:0] t_2a2b_ea1_ABAB_head = (t_2a2b_ea1_ABAB_dep >= t_2a2b_ea1_ABAB_issue) ? t_2a2b_ea1_ABAB_dep : t_2a2b_ea1_ABAB_issue;
wire [7:0] t_2a2b_ea1_ABBA_dep = t_2a2b_ea1_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea1_ABBA_issue = t_2a2b_ea1_BBA_dep + 8'd1;
wire [7:0] t_2a2b_ea1_ABBA_head = (t_2a2b_ea1_ABBA_dep >= t_2a2b_ea1_ABBA_issue) ? t_2a2b_ea1_ABBA_dep : t_2a2b_ea1_ABBA_issue;
wire [7:0] t_2a2b_ea1_BAAA_dep = m4_2a2b_ea1_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea1_BAAA_issue = t_2a2b_ea1_AAA_dep + 8'd1;
wire [7:0] t_2a2b_ea1_BAAA_head = (t_2a2b_ea1_BAAA_dep >= t_2a2b_ea1_BAAA_issue) ? t_2a2b_ea1_BAAA_dep : t_2a2b_ea1_BAAA_issue;
wire [7:0] t_2a2b_ea1_BAAB_dep = t_2a2b_ea1_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea1_BAAB_issue = t_2a2b_ea1_AAB_dep + 8'd1;
wire [7:0] t_2a2b_ea1_BAAB_head = (t_2a2b_ea1_BAAB_dep >= t_2a2b_ea1_BAAB_issue) ? t_2a2b_ea1_BAAB_dep : t_2a2b_ea1_BAAB_issue;
wire [7:0] t_2a2b_ea1_BABA_dep = t_2a2b_ea1_BA_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea1_BABA_issue = t_2a2b_ea1_ABA_head + 8'd1;
wire [7:0] t_2a2b_ea1_BABA_head = (t_2a2b_ea1_BABA_dep >= t_2a2b_ea1_BABA_issue) ? t_2a2b_ea1_BABA_dep : t_2a2b_ea1_BABA_issue;
wire [7:0] t_2a2b_ea1_BBAA_dep = t_2a2b_ea1_BAA_head + B_rev_lat[3];
wire m4_2a2b_ea1_tail_m0_0_pick = (B_len == 3'd2);
wire [8:0] m4_2a2b_ea1_tail_m0_0_value = m4_2a2b_ea1_tail_m0_0_pick ? t_2a2b_ea1_AAAA_dep : t_2a2b_ea1_AAAB_dep;
wire [3:0] m4_2a2b_ea1_tail_m0_0_path = m4_2a2b_ea1_tail_m0_0_pick ? 4'b1111 : 4'b1110;
wire m4_2a2b_ea1_tail_m0_1_pick = (B_len == 3'd3);
wire [7:0] m4_2a2b_ea1_tail_m0_1_value = m4_2a2b_ea1_tail_m0_1_pick ? t_2a2b_ea1_AABA_dep : t_2a2b_ea1_AABB_dep;
wire [3:0] m4_2a2b_ea1_tail_m0_1_path = m4_2a2b_ea1_tail_m0_1_pick ? 4'b1101 : 4'b1100;
wire m4_2a2b_ea1_tail_m0_2_pick = (B_len == 3'd3);
wire [7:0] m4_2a2b_ea1_tail_m0_2_value = m4_2a2b_ea1_tail_m0_2_pick ? t_2a2b_ea1_ABAA_head : t_2a2b_ea1_ABAB_head;
wire [3:0] m4_2a2b_ea1_tail_m0_2_path = m4_2a2b_ea1_tail_m0_2_pick ? 4'b1011 : 4'b1010;
wire m4_2a2b_ea1_tail_m0_3_pick = (B_len == 3'd4);
wire [7:0] m4_2a2b_ea1_tail_m0_3_value = m4_2a2b_ea1_tail_m0_3_pick ? t_2a2b_ea1_ABBA_head : t_2a2b_ea1_BAAA_head;
wire [3:0] m4_2a2b_ea1_tail_m0_3_path = m4_2a2b_ea1_tail_m0_3_pick ? 4'b1001 : 4'b0111;
wire m4_2a2b_ea1_tail_m0_4_pick = (t_2a2b_ea1_BAAB_head <= t_2a2b_ea1_BABA_head);
wire [7:0] m4_2a2b_ea1_tail_m0_4_value = m4_2a2b_ea1_tail_m0_4_pick ? t_2a2b_ea1_BAAB_head : t_2a2b_ea1_BABA_head;
wire [3:0] m4_2a2b_ea1_tail_m0_4_path = m4_2a2b_ea1_tail_m0_4_pick ? 4'b0110 : 4'b0101;
wire m4_2a2b_ea1_tail_m1_0_pick = (B_len == 3'd2 || B_len == 3'd3) && (!(B_len == 3'd3 || B_len == 3'd4) || (m4_2a2b_ea1_tail_m0_0_value <= m4_2a2b_ea1_tail_m0_1_value));
...
wire [7:0] m4_2a2b_ea1_tail_m1_1_value = m4_2a2b_ea1_tail_m1_1_pick ? m4_2a2b_ea1_tail_m0_2_value : m4_2a2b_ea1_tail_m0_3_value;
wire [3:0] m4_2a2b_ea1_tail_m1_1_path = m4_2a2b_ea1_tail_m1_1_pick ? m4_2a2b_ea1_tail_m0_2_path : m4_2a2b_ea1_tail_m0_3_path;
wire m4_2a2b_ea1_tail_m1_2_pick = (m4_2a2b_ea1_tail_m0_4_value <= t_2a2b_ea1_BBAA_dep);
wire [7:0] m4_2a2b_ea1_tail_m1_2_value = m4_2a2b_ea1_tail_m1_2_pick ? m4_2a2b_ea1_tail_m0_4_value : t_2a2b_ea1_BBAA_dep;
wire [3:0] m4_2a2b_ea1_tail_m1_2_path = m4_2a2b_ea1_tail_m1_2_pick ? m4_2a2b_ea1_tail_m0_4_path : 4'b0011;
wire m4_2a2b_ea1_tail_m2_0_pick = (!(B_len == 3'd3 || B_len == 3'd4) || (m4_2a2b_ea1_tail_m1_0_value <= m4_2a2b_ea1_tail_m1_1_value));
...
wire m4_2a2b_ea1_tail_m3_0_pick = (!(B_len == 3'd4) || (m4_2a2b_ea1_tail_m2_0_value <= m4_2a2b_ea1_tail_m1_2_value));
...
wire [8:0] m4_2a2b_ea1_cycle = m4_2a2b_ea1_v && (B_len == 3'd2 || B_len == 3'd3 || B_len == 3'd4) ? m4_2a2b_ea1_tail_m3_0_value : 9'd511;
...
wire [7:0] t_2a2b_ea2_AA_dep = t_2a2b_ea2_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea2_AB_dep = m4_2a2b_ea2_ra + A_rev_lat[2];
wire [7:0] t_2a2b_ea2_AB_issue = t_2a2b_ea2_B_head + 8'd1;
wire [7:0] t_2a2b_ea2_AB_head = (t_2a2b_ea2_AB_dep >= t_2a2b_ea2_AB_issue) ? t_2a2b_ea2_AB_dep : t_2a2b_ea2_AB_issue;
wire [7:0] t_2a2b_ea2_BA_dep = m4_2a2b_ea2_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea2_BA_issue = t_2a2b_ea2_A_head + 8'd1;
wire [7:0] t_2a2b_ea2_BA_head = (t_2a2b_ea2_BA_dep >= t_2a2b_ea2_BA_issue) ? t_2a2b_ea2_BA_dep : t_2a2b_ea2_BA_issue;
wire [7:0] t_2a2b_ea2_BB_dep = t_2a2b_ea2_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea2_AAA_dep = t_2a2b_ea2_AA_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea2_AAB_dep = t_2a2b_ea2_AB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea2_ABA_dep = t_2a2b_ea2_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea2_ABA_issue = t_2a2b_ea2_BA_head + 8'd1;
wire [7:0] t_2a2b_ea2_ABA_head = (t_2a2b_ea2_ABA_dep >= t_2a2b_ea2_ABA_issue) ? t_2a2b_ea2_ABA_dep : t_2a2b_ea2_ABA_issue;
wire [7:0] t_2a2b_ea2_ABB_dep = m4_2a2b_ea2_ra + A_rev_lat[2];
wire [7:0] t_2a2b_ea2_ABB_issue = t_2a2b_ea2_BB_dep + 8'd1;
wire [7:0] t_2a2b_ea2_ABB_head = (t_2a2b_ea2_ABB_dep >= t_2a2b_ea2_ABB_issue) ? t_2a2b_ea2_ABB_dep : t_2a2b_ea2_ABB_issue;
wire [7:0] t_2a2b_ea2_BAA_dep = m4_2a2b_ea2_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea2_BAA_issue = t_2a2b_ea2_AA_dep + 8'd1;
wire [7:0] t_2a2b_ea2_BAA_head = (t_2a2b_ea2_BAA_dep >= t_2a2b_ea2_BAA_issue) ? t_2a2b_ea2_BAA_dep : t_2a2b_ea2_BAA_issue;
wire [7:0] t_2a2b_ea2_BAB_dep = t_2a2b_ea2_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea2_BAB_issue = t_2a2b_ea2_AB_head + 8'd1;
wire [7:0] t_2a2b_ea2_BAB_head = (t_2a2b_ea2_BAB_dep >= t_2a2b_ea2_BAB_issue) ? t_2a2b_ea2_BAB_dep : t_2a2b_ea2_BAB_issue;
wire [7:0] t_2a2b_ea2_BBA_dep = t_2a2b_ea2_BA_head + B_rev_lat[3];
wire [8:0] t_2a2b_ea2_AAAA_dep = t_2a2b_ea2_AAA_dep + A_rev_lat[5];
wire [7:0] t_2a2b_ea2_AAAB_dep = t_2a2b_ea2_AAB_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea2_AABA_dep = t_2a2b_ea2_ABA_head + A_rev_lat[4];
wire [7:0] t_2a2b_ea2_AABB_dep = t_2a2b_ea2_ABB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea2_ABAA_dep = t_2a2b_ea2_AA_dep + A_rev_lat[4];
wire [7:0] t_2a2b_ea2_ABAA_issue = t_2a2b_ea2_BAA_head + 8'd1;
wire [7:0] t_2a2b_ea2_ABAA_head = (t_2a2b_ea2_ABAA_dep >= t_2a2b_ea2_ABAA_issue) ? t_2a2b_ea2_ABAA_dep : t_2a2b_ea2_ABAA_issue;
wire [7:0] t_2a2b_ea2_ABAB_dep = t_2a2b_ea2_AB_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea2_ABAB_issue = t_2a2b_ea2_BAB_head + 8'd1;
wire [7:0] t_2a2b_ea2_ABAB_head = (t_2a2b_ea2_ABAB_dep >= t_2a2b_ea2_ABAB_issue) ? t_2a2b_ea2_ABAB_dep : t_2a2b_ea2_ABAB_issue;
wire [7:0] t_2a2b_ea2_ABBA_dep = t_2a2b_ea2_A_head + A_rev_lat[3];
wire [7:0] t_2a2b_ea2_ABBA_issue = t_2a2b_ea2_BBA_dep + 8'd1;
wire [7:0] t_2a2b_ea2_ABBA_head = (t_2a2b_ea2_ABBA_dep >= t_2a2b_ea2_ABBA_issue) ? t_2a2b_ea2_ABBA_dep : t_2a2b_ea2_ABBA_issue;
wire [7:0] t_2a2b_ea2_BAAA_dep = m4_2a2b_ea2_rb + B_rev_lat[2];
wire [7:0] t_2a2b_ea2_BAAA_issue = t_2a2b_ea2_AAA_dep + 8'd1;
wire [7:0] t_2a2b_ea2_BAAA_head = (t_2a2b_ea2_BAAA_dep >= t_2a2b_ea2_BAAA_issue) ? t_2a2b_ea2_BAAA_dep : t_2a2b_ea2_BAAA_issue;
wire [7:0] t_2a2b_ea2_BAAB_dep = t_2a2b_ea2_B_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea2_BAAB_issue = t_2a2b_ea2_AAB_dep + 8'd1;
wire [7:0] t_2a2b_ea2_BAAB_head = (t_2a2b_ea2_BAAB_dep >= t_2a2b_ea2_BAAB_issue) ? t_2a2b_ea2_BAAB_dep : t_2a2b_ea2_BAAB_issue;
wire [7:0] t_2a2b_ea2_BABA_dep = t_2a2b_ea2_BA_head + B_rev_lat[3];
wire [7:0] t_2a2b_ea2_BABA_issue = t_2a2b_ea2_ABA_head + 8'd1;
wire [7:0] t_2a2b_ea2_BABA_head = (t_2a2b_ea2_BABA_dep >= t_2a2b_ea2_BABA_issue) ? t_2a2b_ea2_BABA_dep : t_2a2b_ea2_BABA_issue;
wire [7:0] t_2a2b_ea2_BBAA_dep = t_2a2b_ea2_BAA_head + B_rev_lat[3];
wire m4_2a2b_ea2_tail_m0_0_pick = (B_len == 3'd2);
wire [8:0] m4_2a2b_ea2_tail_m0_0_value = m4_2a2b_ea2_tail_m0_0_pick ? t_2a2b_ea2_AAAA_dep : t_2a2b_ea2_AAAB_dep;
wire [3:0] m4_2a2b_ea2_tail_m0_0_path = m4_2a2b_ea2_tail_m0_0_pick ? 4'b1111 : 4'b1110;
wire m4_2a2b_ea2_tail_m0_1_pick = (B_len == 3'd3);
wire [7:0] m4_2a2b_ea2_tail_m0_1_value = m4_2a2b_ea2_tail_m0_1_pick ? t_2a2b_ea2_AABA_dep : t_2a2b_ea2_AABB_dep;
wire [3:0] m4_2a2b_ea2_tail_m0_1_path = m4_2a2b_ea2_tail_m0_1_pick ? 4'b1101 : 4'b1100;
wire m4_2a2b_ea2_tail_m0_2_pick = (B_len == 3'd3);
wire [7:0] m4_2a2b_ea2_tail_m0_2_value = m4_2a2b_ea2_tail_m0_2_pick ? t_2a2b_ea2_ABAA_head : t_2a2b_ea2_ABAB_head;
wire [3:0] m4_2a2b_ea2_tail_m0_2_path = m4_2a2b_ea2_tail_m0_2_pick ? 4'b1011 : 4'b1010;
wire m4_2a2b_ea2_tail_m0_3_pick = (B_len == 3'd4);
wire [7:0] m4_2a2b_ea2_tail_m0_3_value = m4_2a2b_ea2_tail_m0_3_pick ? t_2a2b_ea2_ABBA_head : t_2a2b_ea2_BAAA_head;
wire [3:0] m4_2a2b_ea2_tail_m0_3_path = m4_2a2b_ea2_tail_m0_3_pick ? 4'b1001 : 4'b0111;
wire m4_2a2b_ea2_tail_m0_4_pick = (t_2a2b_ea2_BAAB_head <= t_2a2b_ea2_BABA_head);
wire [7:0] m4_2a2b_ea2_tail_m0_4_value = m4_2a2b_ea2_tail_m0_4_pick ? t_2a2b_ea2_BAAB_head : t_2a2b_ea2_BABA_head;
wire [3:0] m4_2a2b_ea2_tail_m0_4_path = m4_2a2b_ea2_tail_m0_4_pick ? 4'b0110 : 4'b0101;
wire m4_2a2b_ea2_tail_m1_0_pick = (B_len == 3'd2 || B_len == 3'd3) && (!(B_len == 3'd3 || B_len == 3'd4) || (m4_2a2b_ea2_tail_m0_0_value <= m4_2a2b_ea2_tail_m0_1_value));
...
wire [7:0] m4_2a2b_ea2_tail_m1_1_value = m4_2a2b_ea2_tail_m1_1_pick ? m4_2a2b_ea2_tail_m0_2_value : m4_2a2b_ea2_tail_m0_3_value;
wire [3:0] m4_2a2b_ea2_tail_m1_1_path = m4_2a2b_ea2_tail_m1_1_pick ? m4_2a2b_ea2_tail_m0_2_path : m4_2a2b_ea2_tail_m0_3_path;
wire m4_2a2b_ea2_tail_m1_2_pick = (m4_2a2b_ea2_tail_m0_4_value <= t_2a2b_ea2_BBAA_dep);
wire [7:0] m4_2a2b_ea2_tail_m1_2_value = m4_2a2b_ea2_tail_m1_2_pick ? m4_2a2b_ea2_tail_m0_4_value : t_2a2b_ea2_BBAA_dep;
wire [3:0] m4_2a2b_ea2_tail_m1_2_path = m4_2a2b_ea2_tail_m1_2_pick ? m4_2a2b_ea2_tail_m0_4_path : 4'b0011;
wire m4_2a2b_ea2_tail_m2_0_pick = (!(B_len == 3'd3 || B_len == 3'd4) || (m4_2a2b_ea2_tail_m1_0_value <= m4_2a2b_ea2_tail_m1_1_value));
...
wire m4_2a2b_ea2_tail_m3_0_pick = (!(B_len == 3'd4) || (m4_2a2b_ea2_tail_m2_0_value <= m4_2a2b_ea2_tail_m1_2_value));
...
wire [8:0] m4_2a2b_ea2_cycle = m4_2a2b_ea2_v && (B_len == 3'd2 || B_len == 3'd3 || B_len == 3'd4) ? m4_2a2b_ea2_tail_m3_0_value : 9'd511;
...
wire [6:0] t_3a1b_ea0_B_dep = m4_3a1b_ea0_rb + B_rev_lat[1];
...
wire [7:0] t_3a1b_ea0_AA_dep = t_3a1b_ea0_A_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea0_AB_dep = m4_3a1b_ea0_ra + A_rev_lat[3];
wire [7:0] t_3a1b_ea0_AB_issue = t_3a1b_ea0_B_head + 8'd1;
wire [7:0] t_3a1b_ea0_AB_head = (t_3a1b_ea0_AB_dep >= t_3a1b_ea0_AB_issue) ? t_3a1b_ea0_AB_dep : t_3a1b_ea0_AB_issue;
wire [6:0] t_3a1b_ea0_BA_dep = m4_3a1b_ea0_rb + B_rev_lat[1];
wire [7:0] t_3a1b_ea0_BA_issue = t_3a1b_ea0_A_head + 8'd1;
wire [7:0] t_3a1b_ea0_BA_head = (t_3a1b_ea0_BA_dep >= t_3a1b_ea0_BA_issue) ? t_3a1b_ea0_BA_dep : t_3a1b_ea0_BA_issue;
wire [7:0] t_3a1b_ea0_BB_dep = t_3a1b_ea0_B_head + B_rev_lat[2];
wire [8:0] t_3a1b_ea0_AAA_dep = t_3a1b_ea0_AA_dep + A_rev_lat[5];
wire [7:0] t_3a1b_ea0_AAB_dep = t_3a1b_ea0_AB_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea0_ABA_dep = t_3a1b_ea0_A_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea0_ABA_issue = t_3a1b_ea0_BA_head + 8'd1;
wire [7:0] t_3a1b_ea0_ABA_head = (t_3a1b_ea0_ABA_dep >= t_3a1b_ea0_ABA_issue) ? t_3a1b_ea0_ABA_dep : t_3a1b_ea0_ABA_issue;
wire [7:0] t_3a1b_ea0_ABB_dep = m4_3a1b_ea0_ra + A_rev_lat[3];
wire [7:0] t_3a1b_ea0_ABB_issue = t_3a1b_ea0_BB_dep + 8'd1;
wire [7:0] t_3a1b_ea0_ABB_head = (t_3a1b_ea0_ABB_dep >= t_3a1b_ea0_ABB_issue) ? t_3a1b_ea0_ABB_dep : t_3a1b_ea0_ABB_issue;
wire [6:0] t_3a1b_ea0_BAA_dep = m4_3a1b_ea0_rb + B_rev_lat[1];
wire [7:0] t_3a1b_ea0_BAA_issue = t_3a1b_ea0_AA_dep + 8'd1;
wire [7:0] t_3a1b_ea0_BAA_head = (t_3a1b_ea0_BAA_dep >= t_3a1b_ea0_BAA_issue) ? t_3a1b_ea0_BAA_dep : t_3a1b_ea0_BAA_issue;
wire [7:0] t_3a1b_ea0_BAB_dep = t_3a1b_ea0_B_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea0_BAB_issue = t_3a1b_ea0_AB_head + 8'd1;
wire [7:0] t_3a1b_ea0_BAB_head = (t_3a1b_ea0_BAB_dep >= t_3a1b_ea0_BAB_issue) ? t_3a1b_ea0_BAB_dep : t_3a1b_ea0_BAB_issue;
wire [7:0] t_3a1b_ea0_BBA_dep = t_3a1b_ea0_BA_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea0_BBB_dep = t_3a1b_ea0_BB_dep + B_rev_lat[3];
wire [8:0] t_3a1b_ea0_AAAB_dep = t_3a1b_ea0_AAB_dep + A_rev_lat[5];
wire [8:0] t_3a1b_ea0_AABA_dep = t_3a1b_ea0_ABA_head + A_rev_lat[5];
wire [7:0] t_3a1b_ea0_AABB_dep = t_3a1b_ea0_ABB_head + A_rev_lat[4];
...
wire [7:0] t_3a1b_ea0_ABAB_dep = t_3a1b_ea0_AB_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea0_ABAB_issue = t_3a1b_ea0_BAB_head + 8'd1;
wire [7:0] t_3a1b_ea0_ABAB_head = (t_3a1b_ea0_ABAB_dep >= t_3a1b_ea0_ABAB_issue) ? t_3a1b_ea0_ABAB_dep : t_3a1b_ea0_ABAB_issue;
wire [7:0] t_3a1b_ea0_ABBA_dep = t_3a1b_ea0_A_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea0_ABBA_issue = t_3a1b_ea0_BBA_dep + 8'd1;
wire [7:0] t_3a1b_ea0_ABBA_head = (t_3a1b_ea0_ABBA_dep >= t_3a1b_ea0_ABBA_issue) ? t_3a1b_ea0_ABBA_dep : t_3a1b_ea0_ABBA_issue;
wire [7:0] t_3a1b_ea0_ABBB_dep = m4_3a1b_ea0_ra + A_rev_lat[3];
wire [7:0] t_3a1b_ea0_ABBB_issue = t_3a1b_ea0_BBB_dep + 8'd1;
wire [7:0] t_3a1b_ea0_ABBB_head = (t_3a1b_ea0_ABBB_dep >= t_3a1b_ea0_ABBB_issue) ? t_3a1b_ea0_ABBB_dep : t_3a1b_ea0_ABBB_issue;
wire [6:0] t_3a1b_ea0_BAAA_dep = m4_3a1b_ea0_rb + B_rev_lat[1];
...
wire [7:0] t_3a1b_ea0_BAAB_dep = t_3a1b_ea0_B_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea0_BAAB_issue = t_3a1b_ea0_AAB_dep + 8'd1;
wire [7:0] t_3a1b_ea0_BAAB_head = (t_3a1b_ea0_BAAB_dep >= t_3a1b_ea0_BAAB_issue) ? t_3a1b_ea0_BAAB_dep : t_3a1b_ea0_BAAB_issue;
wire [7:0] t_3a1b_ea0_BABA_dep = t_3a1b_ea0_BA_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea0_BABA_issue = t_3a1b_ea0_ABA_head + 8'd1;
wire [7:0] t_3a1b_ea0_BABA_head = (t_3a1b_ea0_BABA_dep >= t_3a1b_ea0_BABA_issue) ? t_3a1b_ea0_BABA_dep : t_3a1b_ea0_BABA_issue;
wire [7:0] t_3a1b_ea0_BABB_dep = t_3a1b_ea0_BB_dep + B_rev_lat[3];
wire [7:0] t_3a1b_ea0_BABB_issue = t_3a1b_ea0_ABB_head + 8'd1;
wire [7:0] t_3a1b_ea0_BABB_head = (t_3a1b_ea0_BABB_dep >= t_3a1b_ea0_BABB_issue) ? t_3a1b_ea0_BABB_dep : t_3a1b_ea0_BABB_issue;
wire [8:0] t_3a1b_ea0_BBAA_dep = t_3a1b_ea0_BAA_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea0_BBAB_dep = t_3a1b_ea0_BAB_head + B_rev_lat[3];
wire [8:0] t_3a1b_ea0_BBBA_dep = t_3a1b_ea0_BBA_dep + B_rev_lat[3];
wire m4_3a1b_ea0_tail_m0_0_pick = (t_3a1b_ea0_AAAB_dep <= t_3a1b_ea0_AABA_dep);
wire [8:0] m4_3a1b_ea0_tail_m0_0_value = m4_3a1b_ea0_tail_m0_0_pick ? t_3a1b_ea0_AAAB_dep : t_3a1b_ea0_AABA_dep;
wire [3:0] m4_3a1b_ea0_tail_m0_0_path = m4_3a1b_ea0_tail_m0_0_pick ? 4'b1110 : 4'b1101;
wire m4_3a1b_ea0_tail_m0_1_pick = (B_len == 3'd3);
wire [8:0] m4_3a1b_ea0_tail_m0_1_value = m4_3a1b_ea0_tail_m0_1_pick ? t_3a1b_ea0_AABB_dep : t_3a1b_ea0_ABAA_head;
wire [3:0] m4_3a1b_ea0_tail_m0_1_path = m4_3a1b_ea0_tail_m0_1_pick ? 4'b1100 : 4'b1011;
wire m4_3a1b_ea0_tail_m0_2_pick = (t_3a1b_ea0_ABAB_head <= t_3a1b_ea0_ABBA_head);
wire [7:0] m4_3a1b_ea0_tail_m0_2_value = m4_3a1b_ea0_tail_m0_2_pick ? t_3a1b_ea0_ABAB_head : t_3a1b_ea0_ABBA_head;
wire [3:0] m4_3a1b_ea0_tail_m0_2_path = m4_3a1b_ea0_tail_m0_2_pick ? 4'b1010 : 4'b1001;
wire m4_3a1b_ea0_tail_m0_3_pick = (B_len == 3'd4);
wire [8:0] m4_3a1b_ea0_tail_m0_3_value = m4_3a1b_ea0_tail_m0_3_pick ? t_3a1b_ea0_ABBB_head : t_3a1b_ea0_BAAA_head;
wire [3:0] m4_3a1b_ea0_tail_m0_3_path = m4_3a1b_ea0_tail_m0_3_pick ? 4'b1000 : 4'b0111;
wire m4_3a1b_ea0_tail_m0_4_pick = (t_3a1b_ea0_BAAB_head <= t_3a1b_ea0_BABA_head);
wire [7:0] m4_3a1b_ea0_tail_m0_4_value = m4_3a1b_ea0_tail_m0_4_pick ? t_3a1b_ea0_BAAB_head : t_3a1b_ea0_BABA_head;
wire [3:0] m4_3a1b_ea0_tail_m0_4_path = m4_3a1b_ea0_tail_m0_4_pick ? 4'b0110 : 4'b0101;
wire m4_3a1b_ea0_tail_m0_5_pick = (B_len == 3'd4);
wire [8:0] m4_3a1b_ea0_tail_m0_5_value = m4_3a1b_ea0_tail_m0_5_pick ? t_3a1b_ea0_BABB_head : t_3a1b_ea0_BBAA_dep;
wire [3:0] m4_3a1b_ea0_tail_m0_5_path = m4_3a1b_ea0_tail_m0_5_pick ? 4'b0100 : 4'b0011;
wire m4_3a1b_ea0_tail_m0_6_pick = (t_3a1b_ea0_BBAB_dep <= t_3a1b_ea0_BBBA_dep);
wire [8:0] m4_3a1b_ea0_tail_m0_6_value = m4_3a1b_ea0_tail_m0_6_pick ? t_3a1b_ea0_BBAB_dep : t_3a1b_ea0_BBBA_dep;
wire [3:0] m4_3a1b_ea0_tail_m0_6_path = m4_3a1b_ea0_tail_m0_6_pick ? 4'b0010 : 4'b0001;
wire m4_3a1b_ea0_tail_m1_0_pick = (B_len == 3'd2) && (m4_3a1b_ea0_tail_m0_0_value <= m4_3a1b_ea0_tail_m0_1_value);
...
wire m4_3a1b_ea0_tail_m1_1_pick = (B_len == 3'd3);
...
wire m4_3a1b_ea0_tail_m1_2_pick = (B_len == 3'd3) && (m4_3a1b_ea0_tail_m0_4_value <= m4_3a1b_ea0_tail_m0_5_value);
...
wire m4_3a1b_ea0_tail_m2_0_pick = (B_len == 3'd2 || B_len == 3'd3) && (m4_3a1b_ea0_tail_m1_0_value <= m4_3a1b_ea0_tail_m1_1_value);
...
wire m4_3a1b_ea0_tail_m2_1_pick = (!(B_len == 3'd4) || (m4_3a1b_ea0_tail_m1_2_value <= m4_3a1b_ea0_tail_m0_6_value));
...
wire m4_3a1b_ea0_tail_m3_0_pick = (!(B_len == 3'd3 || B_len == 3'd4) || (m4_3a1b_ea0_tail_m2_0_value <= m4_3a1b_ea0_tail_m2_1_value));
...
wire [8:0] m4_3a1b_ea0_cycle = m4_3a1b_ea0_v && (B_len == 3'd2 || B_len == 3'd3 || B_len == 3'd4) ? m4_3a1b_ea0_tail_m3_0_value : 9'd511;
...
wire [6:0] t_3a1b_ea1_B_dep = m4_3a1b_ea1_rb + B_rev_lat[1];
...
wire [7:0] t_3a1b_ea1_AA_dep = t_3a1b_ea1_A_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea1_AB_dep = m4_3a1b_ea1_ra + A_rev_lat[3];
wire [7:0] t_3a1b_ea1_AB_issue = t_3a1b_ea1_B_head + 8'd1;
wire [7:0] t_3a1b_ea1_AB_head = (t_3a1b_ea1_AB_dep >= t_3a1b_ea1_AB_issue) ? t_3a1b_ea1_AB_dep : t_3a1b_ea1_AB_issue;
wire [6:0] t_3a1b_ea1_BA_dep = m4_3a1b_ea1_rb + B_rev_lat[1];
wire [7:0] t_3a1b_ea1_BA_issue = t_3a1b_ea1_A_head + 8'd1;
wire [7:0] t_3a1b_ea1_BA_head = (t_3a1b_ea1_BA_dep >= t_3a1b_ea1_BA_issue) ? t_3a1b_ea1_BA_dep : t_3a1b_ea1_BA_issue;
wire [7:0] t_3a1b_ea1_BB_dep = t_3a1b_ea1_B_head + B_rev_lat[2];
wire [8:0] t_3a1b_ea1_AAA_dep = t_3a1b_ea1_AA_dep + A_rev_lat[5];
wire [7:0] t_3a1b_ea1_AAB_dep = t_3a1b_ea1_AB_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea1_ABA_dep = t_3a1b_ea1_A_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea1_ABA_issue = t_3a1b_ea1_BA_head + 8'd1;
wire [7:0] t_3a1b_ea1_ABA_head = (t_3a1b_ea1_ABA_dep >= t_3a1b_ea1_ABA_issue) ? t_3a1b_ea1_ABA_dep : t_3a1b_ea1_ABA_issue;
wire [7:0] t_3a1b_ea1_ABB_dep = m4_3a1b_ea1_ra + A_rev_lat[3];
wire [7:0] t_3a1b_ea1_ABB_issue = t_3a1b_ea1_BB_dep + 8'd1;
wire [7:0] t_3a1b_ea1_ABB_head = (t_3a1b_ea1_ABB_dep >= t_3a1b_ea1_ABB_issue) ? t_3a1b_ea1_ABB_dep : t_3a1b_ea1_ABB_issue;
wire [6:0] t_3a1b_ea1_BAA_dep = m4_3a1b_ea1_rb + B_rev_lat[1];
wire [7:0] t_3a1b_ea1_BAA_issue = t_3a1b_ea1_AA_dep + 8'd1;
wire [7:0] t_3a1b_ea1_BAA_head = (t_3a1b_ea1_BAA_dep >= t_3a1b_ea1_BAA_issue) ? t_3a1b_ea1_BAA_dep : t_3a1b_ea1_BAA_issue;
wire [7:0] t_3a1b_ea1_BAB_dep = t_3a1b_ea1_B_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea1_BAB_issue = t_3a1b_ea1_AB_head + 8'd1;
wire [7:0] t_3a1b_ea1_BAB_head = (t_3a1b_ea1_BAB_dep >= t_3a1b_ea1_BAB_issue) ? t_3a1b_ea1_BAB_dep : t_3a1b_ea1_BAB_issue;
wire [7:0] t_3a1b_ea1_BBA_dep = t_3a1b_ea1_BA_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea1_BBB_dep = t_3a1b_ea1_BB_dep + B_rev_lat[3];
wire [8:0] t_3a1b_ea1_AAAB_dep = t_3a1b_ea1_AAB_dep + A_rev_lat[5];
wire [8:0] t_3a1b_ea1_AABA_dep = t_3a1b_ea1_ABA_head + A_rev_lat[5];
wire [7:0] t_3a1b_ea1_AABB_dep = t_3a1b_ea1_ABB_head + A_rev_lat[4];
...
wire [7:0] t_3a1b_ea1_ABAB_dep = t_3a1b_ea1_AB_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea1_ABAB_issue = t_3a1b_ea1_BAB_head + 8'd1;
wire [7:0] t_3a1b_ea1_ABAB_head = (t_3a1b_ea1_ABAB_dep >= t_3a1b_ea1_ABAB_issue) ? t_3a1b_ea1_ABAB_dep : t_3a1b_ea1_ABAB_issue;
wire [7:0] t_3a1b_ea1_ABBA_dep = t_3a1b_ea1_A_head + A_rev_lat[4];
wire [7:0] t_3a1b_ea1_ABBA_issue = t_3a1b_ea1_BBA_dep + 8'd1;
wire [7:0] t_3a1b_ea1_ABBA_head = (t_3a1b_ea1_ABBA_dep >= t_3a1b_ea1_ABBA_issue) ? t_3a1b_ea1_ABBA_dep : t_3a1b_ea1_ABBA_issue;
wire [7:0] t_3a1b_ea1_ABBB_dep = m4_3a1b_ea1_ra + A_rev_lat[3];
wire [7:0] t_3a1b_ea1_ABBB_issue = t_3a1b_ea1_BBB_dep + 8'd1;
wire [7:0] t_3a1b_ea1_ABBB_head = (t_3a1b_ea1_ABBB_dep >= t_3a1b_ea1_ABBB_issue) ? t_3a1b_ea1_ABBB_dep : t_3a1b_ea1_ABBB_issue;
wire [6:0] t_3a1b_ea1_BAAA_dep = m4_3a1b_ea1_rb + B_rev_lat[1];
...
wire [7:0] t_3a1b_ea1_BAAB_dep = t_3a1b_ea1_B_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea1_BAAB_issue = t_3a1b_ea1_AAB_dep + 8'd1;
wire [7:0] t_3a1b_ea1_BAAB_head = (t_3a1b_ea1_BAAB_dep >= t_3a1b_ea1_BAAB_issue) ? t_3a1b_ea1_BAAB_dep : t_3a1b_ea1_BAAB_issue;
wire [7:0] t_3a1b_ea1_BABA_dep = t_3a1b_ea1_BA_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea1_BABA_issue = t_3a1b_ea1_ABA_head + 8'd1;
wire [7:0] t_3a1b_ea1_BABA_head = (t_3a1b_ea1_BABA_dep >= t_3a1b_ea1_BABA_issue) ? t_3a1b_ea1_BABA_dep : t_3a1b_ea1_BABA_issue;
wire [7:0] t_3a1b_ea1_BABB_dep = t_3a1b_ea1_BB_dep + B_rev_lat[3];
wire [7:0] t_3a1b_ea1_BABB_issue = t_3a1b_ea1_ABB_head + 8'd1;
wire [7:0] t_3a1b_ea1_BABB_head = (t_3a1b_ea1_BABB_dep >= t_3a1b_ea1_BABB_issue) ? t_3a1b_ea1_BABB_dep : t_3a1b_ea1_BABB_issue;
wire [8:0] t_3a1b_ea1_BBAA_dep = t_3a1b_ea1_BAA_head + B_rev_lat[2];
wire [7:0] t_3a1b_ea1_BBAB_dep = t_3a1b_ea1_BAB_head + B_rev_lat[3];
wire [8:0] t_3a1b_ea1_BBBA_dep = t_3a1b_ea1_BBA_dep + B_rev_lat[3];
wire m4_3a1b_ea1_tail_m0_0_pick = (t_3a1b_ea1_AAAB_dep <= t_3a1b_ea1_AABA_dep);
wire [8:0] m4_3a1b_ea1_tail_m0_0_value = m4_3a1b_ea1_tail_m0_0_pick ? t_3a1b_ea1_AAAB_dep : t_3a1b_ea1_AABA_dep;
wire [3:0] m4_3a1b_ea1_tail_m0_0_path = m4_3a1b_ea1_tail_m0_0_pick ? 4'b1110 : 4'b1101;
wire m4_3a1b_ea1_tail_m0_1_pick = (B_len == 3'd3);
wire [8:0] m4_3a1b_ea1_tail_m0_1_value = m4_3a1b_ea1_tail_m0_1_pick ? t_3a1b_ea1_AABB_dep : t_3a1b_ea1_ABAA_head;
wire [3:0] m4_3a1b_ea1_tail_m0_1_path = m4_3a1b_ea1_tail_m0_1_pick ? 4'b1100 : 4'b1011;
wire m4_3a1b_ea1_tail_m0_2_pick = (t_3a1b_ea1_ABAB_head <= t_3a1b_ea1_ABBA_head);
wire [7:0] m4_3a1b_ea1_tail_m0_2_value = m4_3a1b_ea1_tail_m0_2_pick ? t_3a1b_ea1_ABAB_head : t_3a1b_ea1_ABBA_head;
wire [3:0] m4_3a1b_ea1_tail_m0_2_path = m4_3a1b_ea1_tail_m0_2_pick ? 4'b1010 : 4'b1001;
wire m4_3a1b_ea1_tail_m0_3_pick = (B_len == 3'd4);
wire [8:0] m4_3a1b_ea1_tail_m0_3_value = m4_3a1b_ea1_tail_m0_3_pick ? t_3a1b_ea1_ABBB_head : t_3a1b_ea1_BAAA_head;
wire [3:0] m4_3a1b_ea1_tail_m0_3_path = m4_3a1b_ea1_tail_m0_3_pick ? 4'b1000 : 4'b0111;
wire m4_3a1b_ea1_tail_m0_4_pick = (t_3a1b_ea1_BAAB_head <= t_3a1b_ea1_BABA_head);
wire [7:0] m4_3a1b_ea1_tail_m0_4_value = m4_3a1b_ea1_tail_m0_4_pick ? t_3a1b_ea1_BAAB_head : t_3a1b_ea1_BABA_head;
wire [3:0] m4_3a1b_ea1_tail_m0_4_path = m4_3a1b_ea1_tail_m0_4_pick ? 4'b0110 : 4'b0101;
wire m4_3a1b_ea1_tail_m0_5_pick = (B_len == 3'd4);
wire [8:0] m4_3a1b_ea1_tail_m0_5_value = m4_3a1b_ea1_tail_m0_5_pick ? t_3a1b_ea1_BABB_head : t_3a1b_ea1_BBAA_dep;
wire [3:0] m4_3a1b_ea1_tail_m0_5_path = m4_3a1b_ea1_tail_m0_5_pick ? 4'b0100 : 4'b0011;
wire m4_3a1b_ea1_tail_m0_6_pick = (t_3a1b_ea1_BBAB_dep <= t_3a1b_ea1_BBBA_dep);
wire [8:0] m4_3a1b_ea1_tail_m0_6_value = m4_3a1b_ea1_tail_m0_6_pick ? t_3a1b_ea1_BBAB_dep : t_3a1b_ea1_BBBA_dep;
wire [3:0] m4_3a1b_ea1_tail_m0_6_path = m4_3a1b_ea1_tail_m0_6_pick ? 4'b0010 : 4'b0001;
wire m4_3a1b_ea1_tail_m1_0_pick = (B_len == 3'd2) && (m4_3a1b_ea1_tail_m0_0_value <= m4_3a1b_ea1_tail_m0_1_value);
...
wire m4_3a1b_ea1_tail_m1_1_pick = (B_len == 3'd3);
...
wire m4_3a1b_ea1_tail_m1_2_pick = (B_len == 3'd3) && (m4_3a1b_ea1_tail_m0_4_value <= m4_3a1b_ea1_tail_m0_5_value);
...
wire m4_3a1b_ea1_tail_m2_0_pick = (B_len == 3'd2 || B_len == 3'd3) && (m4_3a1b_ea1_tail_m1_0_value <= m4_3a1b_ea1_tail_m1_1_value);
...
wire m4_3a1b_ea1_tail_m2_1_pick = (!(B_len == 3'd4) || (m4_3a1b_ea1_tail_m1_2_value <= m4_3a1b_ea1_tail_m0_6_value));
...
wire m4_3a1b_ea1_tail_m3_0_pick = (!(B_len == 3'd3 || B_len == 3'd4) || (m4_3a1b_ea1_tail_m2_0_value <= m4_3a1b_ea1_tail_m2_1_value));
...
wire [8:0] m4_3a1b_ea1_cycle = m4_3a1b_ea1_v && (B_len == 3'd2 || B_len == 3'd3 || B_len == 3'd4) ? m4_3a1b_ea1_tail_m3_0_value : 9'd511;
...
wire [5:0] t_4a0b_ea0_B_dep = m4_4a0b_ea0_rb + B_rev_lat[0];
...
wire [7:0] t_4a0b_ea0_AB_dep = m4_4a0b_ea0_ra + A_rev_lat[4];
wire [7:0] t_4a0b_ea0_AB_issue = t_4a0b_ea0_B_head + 8'd1;
wire [7:0] t_4a0b_ea0_AB_head = (t_4a0b_ea0_AB_dep >= t_4a0b_ea0_AB_issue) ? t_4a0b_ea0_AB_dep : t_4a0b_ea0_AB_issue;
wire [5:0] t_4a0b_ea0_BA_dep = m4_4a0b_ea0_rb + B_rev_lat[0];
wire [7:0] t_4a0b_ea0_BA_issue = t_4a0b_ea0_A_head + 8'd1;
wire [7:0] t_4a0b_ea0_BA_head = (t_4a0b_ea0_BA_dep >= t_4a0b_ea0_BA_issue) ? t_4a0b_ea0_BA_dep : t_4a0b_ea0_BA_issue;
wire [7:0] t_4a0b_ea0_BB_dep = t_4a0b_ea0_B_head + B_rev_lat[1];
...
wire [7:0] t_4a0b_ea0_ABB_dep = m4_4a0b_ea0_ra + A_rev_lat[4];
wire [7:0] t_4a0b_ea0_ABB_issue = t_4a0b_ea0_BB_dep + 8'd1;
wire [7:0] t_4a0b_ea0_ABB_head = (t_4a0b_ea0_ABB_dep >= t_4a0b_ea0_ABB_issue) ? t_4a0b_ea0_ABB_dep : t_4a0b_ea0_ABB_issue;
wire [5:0] t_4a0b_ea0_BAA_dep = m4_4a0b_ea0_rb + B_rev_lat[0];
...
wire [7:0] t_4a0b_ea0_BAB_dep = t_4a0b_ea0_B_head + B_rev_lat[1];
wire [7:0] t_4a0b_ea0_BAB_issue = t_4a0b_ea0_AB_head + 8'd1;
wire [7:0] t_4a0b_ea0_BAB_head = (t_4a0b_ea0_BAB_dep >= t_4a0b_ea0_BAB_issue) ? t_4a0b_ea0_BAB_dep : t_4a0b_ea0_BAB_issue;
...
wire [7:0] t_4a0b_ea0_ABBB_dep = m4_4a0b_ea0_ra + A_rev_lat[4];
...
wire [7:0] t_4a0b_ea0_BAAB_dep = t_4a0b_ea0_B_head + B_rev_lat[1];
...
wire m4_4a0b_ea0_tail_m0_0_pick = (t_4a0b_ea0_AABB_dep <= t_4a0b_ea0_ABAB_head);
wire [8:0] m4_4a0b_ea0_tail_m0_0_value = m4_4a0b_ea0_tail_m0_0_pick ? t_4a0b_ea0_AABB_dep : t_4a0b_ea0_ABAB_head;
wire [3:0] m4_4a0b_ea0_tail_m0_0_path = m4_4a0b_ea0_tail_m0_0_pick ? 4'b1100 : 4'b1010;
wire m4_4a0b_ea0_tail_m0_1_pick = (B_len == 3'd2);
wire [8:0] m4_4a0b_ea0_tail_m0_1_value = m4_4a0b_ea0_tail_m0_1_pick ? t_4a0b_ea0_ABBA_head : t_4a0b_ea0_ABBB_head;
wire [3:0] m4_4a0b_ea0_tail_m0_1_path = m4_4a0b_ea0_tail_m0_1_pick ? 4'b1001 : 4'b1000;
wire m4_4a0b_ea0_tail_m0_2_pick = (t_4a0b_ea0_BAAB_head <= t_4a0b_ea0_BABA_head);
wire [8:0] m4_4a0b_ea0_tail_m0_2_value = m4_4a0b_ea0_tail_m0_2_pick ? t_4a0b_ea0_BAAB_head : t_4a0b_ea0_BABA_head;
wire [3:0] m4_4a0b_ea0_tail_m0_2_path = m4_4a0b_ea0_tail_m0_2_pick ? 4'b0110 : 4'b0101;
wire m4_4a0b_ea0_tail_m0_3_pick = (B_len == 3'd3);
wire [8:0] m4_4a0b_ea0_tail_m0_3_value = m4_4a0b_ea0_tail_m0_3_pick ? t_4a0b_ea0_BABB_head : t_4a0b_ea0_BBAA_dep;
wire [3:0] m4_4a0b_ea0_tail_m0_3_path = m4_4a0b_ea0_tail_m0_3_pick ? 4'b0100 : 4'b0011;
wire m4_4a0b_ea0_tail_m0_4_pick = (t_4a0b_ea0_BBAB_dep <= t_4a0b_ea0_BBBA_dep);
wire [8:0] m4_4a0b_ea0_tail_m0_4_value = m4_4a0b_ea0_tail_m0_4_pick ? t_4a0b_ea0_BBAB_dep : t_4a0b_ea0_BBBA_dep;
wire [3:0] m4_4a0b_ea0_tail_m0_4_path = m4_4a0b_ea0_tail_m0_4_pick ? 4'b0010 : 4'b0001;
wire m4_4a0b_ea0_tail_m1_0_pick = (B_len == 3'd2) && (m4_4a0b_ea0_tail_m0_0_value <= m4_4a0b_ea0_tail_m0_1_value);
...
wire m4_4a0b_ea0_tail_m1_1_pick = (B_len == 3'd2) && (m4_4a0b_ea0_tail_m0_2_value <= m4_4a0b_ea0_tail_m0_3_value);
...
wire m4_4a0b_ea0_tail_m1_2_pick = (B_len == 3'd3);
wire [8:0] m4_4a0b_ea0_tail_m1_2_value = m4_4a0b_ea0_tail_m1_2_pick ? m4_4a0b_ea0_tail_m0_4_value : t_4a0b_ea0_BBBB_dep;
...
wire m4_4a0b_ea0_tail_m3_0_pick = (B_len == 3'd2 || B_len == 3'd3) && (!(B_len == 3'd3 || B_len == 3'd4) || (m4_4a0b_ea0_tail_m2_0_value <= m4_4a0b_ea0_tail_m1_2_value));
...
wire [8:0] m4_4a0b_ea0_cycle = m4_4a0b_ea0_v && (B_len == 3'd2 || B_len == 3'd3 || B_len == 3'd4) ? m4_4a0b_ea0_tail_m3_0_value : 9'd511;
